...
<span id="as_x<?php echo $detailterimagudang_grid->RowIndex ?>_id_barang">
	<div class="input-group">
		<input type="text" class="form-control" name="sv_x<?php echo $detailterimagudang_grid->RowIndex ?>_id_barang" id="sv_x<?php echo $detailterimagudang_grid->RowIndex ?>_id_barang" value="<?php echo RemoveHtml($detailterimagudang_grid->id_barang->EditValue) ?>" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($detailterimagudang_grid->id_barang->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($detailterimagudang_grid->id_barang->getPlaceHolder()) ?>"<?php echo $detailterimagudang_grid->id_barang->editAttributes() ?>>
