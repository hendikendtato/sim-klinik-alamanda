...
<span id="as_x_id_barang">
	<div class="input-group">
		<input type="text" class="form-control" name="sv_x_id_barang" id="sv_x_id_barang" value="<?php echo RemoveHtml($detailterimagudang_edit->id_barang->EditValue) ?>" size="30" maxlength="50" placeholder="<?php echo HtmlEncode($detailterimagudang_edit->id_barang->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($detailterimagudang_edit->id_barang->getPlaceHolder()) ?>"<?php echo $detailterimagudang_edit->id_barang->editAttributes() ?>>
...
<input type="text" data-table="detailterimagudang" data-field="x_qty" name="x_qty" id="x_qty" size="30" maxlength="22" placeholder="<?php echo HtmlEncode($detailterimagudang_edit->qty->getPlaceHolder()) ?>" value="<?php echo $detailterimagudang_edit->qty->EditValue ?>"<?php echo $detailterimagudang_edit->qty->editAttributes() ?>>
</span>
