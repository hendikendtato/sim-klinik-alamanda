...
loadjs.ready("head", function() {
	...
	$.get(base_url+"?api?action=checkBulanan",function(a){a.isChecked||($("#checkStatusPelanggan").append('<span style="border-radius: 50%; padding: 5px; display: inline-block;" class="badge badge-danger"></span>'),$('[name="mi_m_pelanggan"] a:eq(0)').append('<span style="border-radius: 50%; padding: 5px; display: inline-block;" class="badge badge-danger"></span>'),$('[name="mci_Master"] a:eq(0)').append('<span style="border-radius: 50%; padding: 5px; display: inline-block;" class="badge badge-danger"></span>'))});
});
</script>
<!-- Navbar -->
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>ikon.ico">
<link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>ikon.ico">
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="#"  onclick="return false;">
				<span class="brand-text">Sistem Informasi Klinik</span>
			</a>
		</ul>
		<!-- Right navbar links -->
