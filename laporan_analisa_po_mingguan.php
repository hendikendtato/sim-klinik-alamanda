...
// Create page object
$laporan_analisa_po_mingguan = new laporan_analisa_po_mingguan();

// Run the page
$laporan_analisa_po_mingguan->run();
...
<?php
$laporan_analisa_po_mingguan->terminate();
?>