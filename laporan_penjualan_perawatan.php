...
// Create page object
$laporan_penjualan_perawatan = new laporan_penjualan_perawatan();

// Run the page
$laporan_penjualan_perawatan->run();
  ...
  <div class="row">
		...
		<thead>
			<tr>
				<td colspan="3" style="text-align: center;">
					<div class="col">
						<h5>Laporan Penjualan Perawatan</h5>
						<h5>Cabang 
							<?php 
								if($result != false) {
	...
	<script>
		function exportTableToExcel(tableID, filename = '') {
				...
				// Specify file name
				filename = filename ? filename + '.xls' : 'Laporan Penjualan Perawatan '+ d.toDateString() +'.xls';
