...
<input type="text" data-table="m_target_pasien" data-field="x_target" name="x_target" id="x_target" size="30" maxlength="50" placeholder="<?php echo HtmlEncode($m_target_pasien_add->target->getPlaceHolder()) ?>" value="<?php echo $m_target_pasien_add->target->EditValue ?>"<?php echo $m_target_pasien_add->target->editAttributes() ?>>
</span>
