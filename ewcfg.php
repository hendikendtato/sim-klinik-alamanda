...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "klinik_latest_26_03_21"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'LlvnarliOMCjdLgr', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/klinik_latest_26_03_21.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{7561FF98-88C2-4B76-B5C9-C5F11860BCF7}", // Project ID (GUID)
	...
	"ADMIN_PASSWORD" => "alamanda54321", // Administrator password
	...
	"LOGIN_PASSWORD_FIELD_NAME" => "userpwd",
	"USER_ID_FIELD_NAME" => "",
	...
	"EXPORT_ALL_TIME_LIMIT" => 300, // Export all records time limit
