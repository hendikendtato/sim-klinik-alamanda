...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "klinik_latest_09_04_21"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '7bn5s5ee5NsYpF7c', // Random key for encryption
	...
	"PROJECT_ID" => "{8C91985A-7590-4658-895B-4BCC6B46002F}", // Project ID (GUID)
