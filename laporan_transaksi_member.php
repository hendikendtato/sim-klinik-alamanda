...
// Create page object
$laporan_transaksi_member = new laporan_transaksi_member();

// Run the page
$laporan_transaksi_member->run();
			...
			<div class="col-md-12">
				<ul class="list-unstyled">
					<li class="d-inline-block">
						...
						<select class="form-control product-select" name="jenis_member">
							<?php
	...
	<div class="row">
			...
			<thead>
				<tr>
					<td colspan="2" style="text-align: center;">
						<div class="col">
							<h5>Laporan Transaksi Member</h5>
							<h5>Cabang 
								<?php 
									if($nama_cabang){	 
		...
		<script>
			function exportTableToExcel(tableID, filename = '') {
				...
				// Specify file name
				filename = filename ? filename + '.xls' : 'Laporan Transaksi Member '+ d.toDateString() +'.xls';
...
<?php
$laporan_transaksi_member->terminate();
?>