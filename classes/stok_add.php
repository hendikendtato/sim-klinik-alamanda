...
class stok_add extends stok
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_stok") !== NULL) {
				...
				$this->setKey("id_stok", $this->id_stok->CurrentValue); // Set up key
			} else {
				$this->setKey("id_stok", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "stokview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_stok->OldValue = $this->id_stok->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_stok'] = $this->id_stok->CurrentValue;
