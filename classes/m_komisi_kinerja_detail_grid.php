 ...
 * Page class
 */
class m_komisi_kinerja_detail_grid extends m_komisi_kinerja_detail
{
	...
	// Table name
	public $TableName = 'm_komisi_kinerja_detail';

	// Page object name
	public $PageObjName = "m_komisi_kinerja_detail_grid";

	// Grid form hidden field names
	public $FormName = "fm_komisi_kinerja_detailgrid";
	...
	public function __construct()
	{
		...
		// Table object (m_komisi_kinerja_detail)
		if (!isset($GLOBALS["m_komisi_kinerja_detail"]) || get_class($GLOBALS["m_komisi_kinerja_detail"]) == PROJECT_NAMESPACE . "m_komisi_kinerja_detail") {
			$GLOBALS["m_komisi_kinerja_detail"] = &$this;

			// $GLOBALS["MasterTable"] = &$GLOBALS["Table"];
			// if (!isset($GLOBALS["Table"]))
			// 	$GLOBALS["Table"] = &$GLOBALS["m_komisi_kinerja_detail"];

		}
		$this->AddUrl = "m_komisi_kinerja_detailadd.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'm_komisi_kinerja_detail');
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $m_komisi_kinerja_detail;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($m_komisi_kinerja_detail);
				$doc->Text = @$content;
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function run()
	{
		...
		$this->kinerja_default_persen->setVisibility();
		$this->kinerja_default_rupiah->setVisibility();
		$this->kinerja_target_persen->setVisibility();
		$this->kinerja_target_rupiah->setVisibility();
	...
	{
		$this->kinerja_default_persen->FormValue = ""; // Clear form value
		$this->kinerja_default_rupiah->FormValue = ""; // Clear form value
		$this->kinerja_target_persen->FormValue = ""; // Clear form value
		$this->kinerja_target_rupiah->FormValue = ""; // Clear form value
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_id_barang") && $CurrentForm->hasValue("o_id_barang") && $this->id_barang->CurrentValue != $this->id_barang->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_kinerja_default_persen") && $CurrentForm->hasValue("o_kinerja_default_persen") && $this->kinerja_default_persen->CurrentValue != $this->kinerja_default_persen->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_kinerja_default_rupiah") && $CurrentForm->hasValue("o_kinerja_default_rupiah") && $this->kinerja_default_rupiah->CurrentValue != $this->kinerja_default_rupiah->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_kinerja_target_persen") && $CurrentForm->hasValue("o_kinerja_target_persen") && $this->kinerja_target_persen->CurrentValue != $this->kinerja_target_persen->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_kinerja_target_rupiah") && $CurrentForm->hasValue("o_kinerja_target_rupiah") && $this->kinerja_target_rupiah->CurrentValue != $this->kinerja_target_rupiah->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->kinerja_default_persen->CurrentValue = NULL;
		$this->kinerja_default_persen->OldValue = $this->kinerja_default_persen->CurrentValue;
		$this->kinerja_default_rupiah->CurrentValue = NULL;
		$this->kinerja_default_rupiah->OldValue = $this->kinerja_default_rupiah->CurrentValue;
		$this->kinerja_target_persen->CurrentValue = NULL;
		$this->kinerja_target_persen->OldValue = $this->kinerja_target_persen->CurrentValue;
		$this->kinerja_target_rupiah->CurrentValue = NULL;
		$this->kinerja_target_rupiah->OldValue = $this->kinerja_target_rupiah->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_kinerja_default_persen"))
			$this->kinerja_default_persen->setOldValue($CurrentForm->getValue("o_kinerja_default_persen"));
		...
		if ($CurrentForm->hasValue("o_kinerja_default_rupiah"))
			$this->kinerja_default_rupiah->setOldValue($CurrentForm->getValue("o_kinerja_default_rupiah"));
		...
		if ($CurrentForm->hasValue("o_kinerja_target_persen"))
			$this->kinerja_target_persen->setOldValue($CurrentForm->getValue("o_kinerja_target_persen"));
		...
		if ($CurrentForm->hasValue("o_kinerja_target_rupiah"))
			$this->kinerja_target_rupiah->setOldValue($CurrentForm->getValue("o_kinerja_target_rupiah"));
	...
	public function restoreFormValues()
	{
		...
		$this->kinerja_default_persen->CurrentValue = $this->kinerja_default_persen->FormValue;
		$this->kinerja_default_rupiah->CurrentValue = $this->kinerja_default_rupiah->FormValue;
		$this->kinerja_target_persen->CurrentValue = $this->kinerja_target_persen->FormValue;
		$this->kinerja_target_rupiah->CurrentValue = $this->kinerja_target_rupiah->FormValue;
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->kinerja_default_persen->setDbValue($row['kinerja_default_persen']);
		$this->kinerja_default_rupiah->setDbValue($row['kinerja_default_rupiah']);
		$this->kinerja_target_persen->setDbValue($row['kinerja_target_persen']);
		$this->kinerja_target_rupiah->setDbValue($row['kinerja_target_rupiah']);
	...
	protected function newRow()
	{
		...
		$row['kinerja_default_persen'] = $this->kinerja_default_persen->CurrentValue;
		$row['kinerja_default_rupiah'] = $this->kinerja_default_rupiah->CurrentValue;
		$row['kinerja_target_persen'] = $this->kinerja_target_persen->CurrentValue;
		$row['kinerja_target_rupiah'] = $this->kinerja_target_rupiah->CurrentValue;
	...
	public function renderRow()
	{
		...
		if ($this->kinerja_default_persen->FormValue == $this->kinerja_default_persen->CurrentValue && is_numeric(ConvertToFloatString($this->kinerja_default_persen->CurrentValue)))
			$this->kinerja_default_persen->CurrentValue = ConvertToFloatString($this->kinerja_default_persen->CurrentValue);

		// Convert decimal values if posted back
		if ($this->kinerja_default_rupiah->FormValue == $this->kinerja_default_rupiah->CurrentValue && is_numeric(ConvertToFloatString($this->kinerja_default_rupiah->CurrentValue)))
			$this->kinerja_default_rupiah->CurrentValue = ConvertToFloatString($this->kinerja_default_rupiah->CurrentValue);

		// Convert decimal values if posted back
		if ($this->kinerja_target_persen->FormValue == $this->kinerja_target_persen->CurrentValue && is_numeric(ConvertToFloatString($this->kinerja_target_persen->CurrentValue)))
			$this->kinerja_target_persen->CurrentValue = ConvertToFloatString($this->kinerja_target_persen->CurrentValue);

		// Convert decimal values if posted back
		if ($this->kinerja_target_rupiah->FormValue == $this->kinerja_target_rupiah->CurrentValue && is_numeric(ConvertToFloatString($this->kinerja_target_rupiah->CurrentValue)))
			$this->kinerja_target_rupiah->CurrentValue = ConvertToFloatString($this->kinerja_target_rupiah->CurrentValue);
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->kinerja_default_persen->EditValue = HtmlEncode($this->kinerja_default_persen->CurrentValue);
			...
			if (strval($this->kinerja_default_persen->EditValue) != "" && is_numeric($this->kinerja_default_persen->EditValue)) {
				...
				$this->kinerja_default_persen->OldValue = $this->kinerja_default_persen->EditValue;
			}
			...
			$this->kinerja_default_rupiah->EditValue = HtmlEncode($this->kinerja_default_rupiah->CurrentValue);
			...
			if (strval($this->kinerja_default_rupiah->EditValue) != "" && is_numeric($this->kinerja_default_rupiah->EditValue)) {
				...
				$this->kinerja_default_rupiah->OldValue = $this->kinerja_default_rupiah->EditValue;
			}
			...
			$this->kinerja_target_persen->EditValue = HtmlEncode($this->kinerja_target_persen->CurrentValue);
			...
			if (strval($this->kinerja_target_persen->EditValue) != "" && is_numeric($this->kinerja_target_persen->EditValue)) {
				...
				$this->kinerja_target_persen->OldValue = $this->kinerja_target_persen->EditValue;
			}
			...
			$this->kinerja_target_rupiah->EditValue = HtmlEncode($this->kinerja_target_rupiah->CurrentValue);
			...
			if (strval($this->kinerja_target_rupiah->EditValue) != "" && is_numeric($this->kinerja_target_rupiah->EditValue)) {
				...
				$this->kinerja_target_rupiah->OldValue = $this->kinerja_target_rupiah->EditValue;
			}
	...
	protected function validateForm()
	{
		...
		if ($this->kinerja_default_persen->Required) {
			if (!$this->kinerja_default_persen->IsDetailKey && $this->kinerja_default_persen->FormValue != NULL && $this->kinerja_default_persen->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->kinerja_default_persen->caption(), $this->kinerja_default_persen->RequiredErrorMessage));
			}
		}
		if (!CheckNumber($this->kinerja_default_persen->FormValue)) {
			AddMessage($FormError, $this->kinerja_default_persen->errorMessage());
		}
		if ($this->kinerja_default_rupiah->Required) {
			if (!$this->kinerja_default_rupiah->IsDetailKey && $this->kinerja_default_rupiah->FormValue != NULL && $this->kinerja_default_rupiah->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->kinerja_default_rupiah->caption(), $this->kinerja_default_rupiah->RequiredErrorMessage));
			}
		}
		if (!CheckNumber($this->kinerja_default_rupiah->FormValue)) {
			AddMessage($FormError, $this->kinerja_default_rupiah->errorMessage());
		}
		if ($this->kinerja_target_persen->Required) {
			if (!$this->kinerja_target_persen->IsDetailKey && $this->kinerja_target_persen->FormValue != NULL && $this->kinerja_target_persen->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->kinerja_target_persen->caption(), $this->kinerja_target_persen->RequiredErrorMessage));
			}
		}
		if (!CheckNumber($this->kinerja_target_persen->FormValue)) {
			AddMessage($FormError, $this->kinerja_target_persen->errorMessage());
		}
		if ($this->kinerja_target_rupiah->Required) {
			if (!$this->kinerja_target_rupiah->IsDetailKey && $this->kinerja_target_rupiah->FormValue != NULL && $this->kinerja_target_rupiah->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->kinerja_target_rupiah->caption(), $this->kinerja_target_rupiah->RequiredErrorMessage));
			}
		}
		if (!CheckNumber($this->kinerja_target_rupiah->FormValue)) {
			AddMessage($FormError, $this->kinerja_target_rupiah->errorMessage());
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// kinerja_default_persen
			$this->kinerja_default_persen->setDbValueDef($rsnew, $this->kinerja_default_persen->CurrentValue, NULL, $this->kinerja_default_persen->ReadOnly);

			// kinerja_default_rupiah
			$this->kinerja_default_rupiah->setDbValueDef($rsnew, $this->kinerja_default_rupiah->CurrentValue, NULL, $this->kinerja_default_rupiah->ReadOnly);

			// kinerja_target_persen
			$this->kinerja_target_persen->setDbValueDef($rsnew, $this->kinerja_target_persen->CurrentValue, NULL, $this->kinerja_target_persen->ReadOnly);

			// kinerja_target_rupiah
			$this->kinerja_target_rupiah->setDbValueDef($rsnew, $this->kinerja_target_rupiah->CurrentValue, NULL, $this->kinerja_target_rupiah->ReadOnly);
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'm_komisi_kinerja_detail'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_m_komisi();
		...
		// kinerja_default_persen
		$this->kinerja_default_persen->setDbValueDef($rsnew, $this->kinerja_default_persen->CurrentValue, NULL, FALSE);

		// kinerja_default_rupiah
		$this->kinerja_default_rupiah->setDbValueDef($rsnew, $this->kinerja_default_rupiah->CurrentValue, NULL, FALSE);

		// kinerja_target_persen
		$this->kinerja_target_persen->setDbValueDef($rsnew, $this->kinerja_target_persen->CurrentValue, NULL, FALSE);

		// kinerja_target_rupiah
		$this->kinerja_target_rupiah->setDbValueDef($rsnew, $this->kinerja_target_rupiah->CurrentValue, NULL, FALSE);
