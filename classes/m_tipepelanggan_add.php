 ...
 * Page class
 */
class m_tipepelanggan_add extends m_tipepelanggan
{
	...
	// Page object name
	public $PageObjName = "m_tipepelanggan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_tipe") !== NULL) {
				...
				$this->setKey("id_tipe", $this->id_tipe->CurrentValue); // Set up key
			} else {
				$this->setKey("id_tipe", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_tipepelangganview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_tipe->OldValue = $this->id_tipe->CurrentValue;
		$this->nama_tipe->CurrentValue = NULL;
		$this->nama_tipe->OldValue = $this->nama_tipe->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_tipe'] = $this->id_tipe->CurrentValue;
		$row['nama_tipe'] = $this->nama_tipe->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// nama_tipe
		$this->nama_tipe->setDbValueDef($rsnew, $this->nama_tipe->CurrentValue, NULL, FALSE);
