 ...
 * Page class
 */
class detailkirimbarang_grid extends detailkirimbarang
{
	...
	// Page object name
	public $PageObjName = "detailkirimbarang_grid";

	// Grid form hidden field names
	public $FormName = "fdetailkirimbaranggrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "kirimbarang") {
			$this->id_kirimbarang->Visible = FALSE;
			if ($GLOBALS["kirimbarang"]->EventCancelled)
