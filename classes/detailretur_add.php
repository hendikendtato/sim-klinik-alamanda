 ...
 * Page class
 */
class detailretur_add extends detailretur
{
	...
	// Page object name
	public $PageObjName = "detailretur_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailretur") !== NULL) {
				...
				$this->setKey("id_detailretur", $this->id_detailretur->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailretur", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("detailreturlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "detailreturlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "detailreturview.php")
