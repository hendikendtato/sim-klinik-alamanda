 ...
 * Page class
 */
class detailmutasibank_delete extends detailmutasibank
{
	...
	// Page object name
	public $PageObjName = "detailmutasibank_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailmutasibanklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailmutasibanklist.php"); // Return to list
			}
		}
	}
