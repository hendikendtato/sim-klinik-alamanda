...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// tablename
		$this->_tablename = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 191, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('userlevelpermissions', 'userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, 11, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("userlevelpermissionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("userlevelpermissionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "userlevelpermissionsadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("userlevelpermissionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("userlevelpermissionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("userlevelpermissionsdelete.php", $this->getUrlParm());
	}
