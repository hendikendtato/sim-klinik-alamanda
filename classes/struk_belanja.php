...
class struk_belanja
{
	...
	// Table name
	public $TableName = 'struk_belanja.php';

	// Page object name
	public $PageObjName = "struk_belanja";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'struk_belanja.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "struk_belanja", $url, "", "struk_belanja", TRUE);
		$this->Heading = $Language->TablePhrase("struk_belanja", "TblCaption"); 
	}
} // End class
?>