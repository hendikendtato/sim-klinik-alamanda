 ...
 * Page class
 */
class m_penyimpanan_add extends m_penyimpanan
{
	...
	// Page object name
	public $PageObjName = "m_penyimpanan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_penyimpanan") !== NULL) {
				...
				$this->setKey("id_penyimpanan", $this->id_penyimpanan->CurrentValue); // Set up key
			} else {
				$this->setKey("id_penyimpanan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_penyimpananview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_penyimpanan->OldValue = $this->id_penyimpanan->CurrentValue;
		$this->nama_barang->CurrentValue = NULL;
		$this->nama_barang->OldValue = $this->nama_barang->CurrentValue;
		$this->tanggal_->CurrentValue = NULL;
		$this->tanggal_->OldValue = $this->tanggal_->CurrentValue;
		$this->penyimpanan->CurrentValue = NULL;
		$this->penyimpanan->OldValue = $this->penyimpanan->CurrentValue;
		$this->nomor_laci->CurrentValue = NULL;
		$this->nomor_laci->OldValue = $this->nomor_laci->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_penyimpanan'] = $this->id_penyimpanan->CurrentValue;
		$row['nama_barang'] = $this->nama_barang->CurrentValue;
		$row['tanggal_'] = $this->tanggal_->CurrentValue;
		$row['penyimpanan'] = $this->penyimpanan->CurrentValue;
		$row['nomor_laci'] = $this->nomor_laci->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// tanggal_
		$this->tanggal_->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_->CurrentValue, 0), NULL, FALSE);

		// penyimpanan
		$this->penyimpanan->setDbValueDef($rsnew, $this->penyimpanan->CurrentValue, NULL, FALSE);

		// nomor_laci
		$this->nomor_laci->setDbValueDef($rsnew, $this->nomor_laci->CurrentValue, NULL, FALSE);
