 ...
 * Page class
 */
class detailkirimbarang_delete extends detailkirimbarang
{
	...
	// Page object name
	public $PageObjName = "detailkirimbarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailkirimbaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailkirimbaranglist.php"); // Return to list
			}
		}
	}
