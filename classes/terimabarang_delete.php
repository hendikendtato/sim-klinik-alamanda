 ...
 * Page class
 */
class terimabarang_delete extends terimabarang
{
	...
	// Page object name
	public $PageObjName = "terimabarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("terimabaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("terimabaranglist.php"); // Return to list
			}
		}
	}
