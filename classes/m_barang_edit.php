 ...
 * Page class
 */
class m_barang_edit extends m_barang
{
	...
	// Page object name
	public $PageObjName = "m_barang_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// komposisi
			$this->komposisi->setDbValueDef($rsnew, $this->komposisi->CurrentValue, NULL, $this->komposisi->ReadOnly);

			// tipe
			$this->tipe->setDbValueDef($rsnew, $this->tipe->CurrentValue, NULL, $this->tipe->ReadOnly);

			// shortname_barang
			$this->shortname_barang->setDbValueDef($rsnew, $this->shortname_barang->CurrentValue, NULL, $this->shortname_barang->ReadOnly);

			// id_tag
			$this->id_tag->setDbValueDef($rsnew, $this->id_tag->CurrentValue, NULL, $this->id_tag->ReadOnly);

			// discontinue
			$this->discontinue->setDbValueDef($rsnew, $this->discontinue->CurrentValue, NULL, $this->discontinue->ReadOnly);
