...
/**
 * Table class for V_kartustok
 */
class V_kartustok extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'V_kartustok';
		$this->TableName = 'V_kartustok';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`V_kartustok`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('V_kartustok', 'V_kartustok', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// kode_barang
		$this->kode_barang = new DbField('V_kartustok', 'V_kartustok', 'x_kode_barang', 'kode_barang', '`kode_barang`', '`kode_barang`', 200, 255, -1, FALSE, '`kode_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_barang->Sortable = TRUE; // Allow sort
		$this->fields['kode_barang'] = &$this->kode_barang;

		// nama_barang
		$this->nama_barang = new DbField('V_kartustok', 'V_kartustok', 'x_nama_barang', 'nama_barang', '`nama_barang`', '`nama_barang`', 200, 255, -1, FALSE, '`nama_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_barang->Sortable = TRUE; // Allow sort
		$this->fields['nama_barang'] = &$this->nama_barang;

		// satuan
		$this->satuan = new DbField('V_kartustok', 'V_kartustok', 'x_satuan', 'satuan', '`satuan`', '`satuan`', 3, 11, -1, FALSE, '`satuan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenis
		$this->jenis = new DbField('V_kartustok', 'V_kartustok', 'x_jenis', 'jenis', '`jenis`', '`jenis`', 3, 11, -1, FALSE, '`jenis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kategori
		$this->kategori = new DbField('V_kartustok', 'V_kartustok', 'x_kategori', 'kategori', '`kategori`', '`kategori`', 3, 11, -1, FALSE, '`kategori`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// subkategori
		$this->subkategori = new DbField('V_kartustok', 'V_kartustok', 'x_subkategori', 'subkategori', '`subkategori`', '`subkategori`', 3, 11, -1, FALSE, '`subkategori`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// komposisi
		$this->komposisi = new DbField('V_kartustok', 'V_kartustok', 'x_komposisi', 'komposisi', '`komposisi`', '`komposisi`', 202, 3, -1, FALSE, '`komposisi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->komposisi->Sortable = TRUE; // Allow sort
		$this->komposisi->Lookup = new Lookup('komposisi', 'V_kartustok', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->komposisi->OptionCount = 2;
		$this->fields['komposisi'] = &$this->komposisi;

		// tipe
		$this->tipe = new DbField('V_kartustok', 'V_kartustok', 'x_tipe', 'tipe', '`tipe`', '`tipe`', 202, 9, -1, FALSE, '`tipe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->tipe->Sortable = TRUE; // Allow sort
		$this->tipe->Lookup = new Lookup('tipe', 'V_kartustok', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->tipe->OptionCount = 4;
		$this->fields['tipe'] = &$this->tipe;

		// status
		$this->status = new DbField('V_kartustok', 'V_kartustok', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "kartustok") {
			$detailUrl = $GLOBALS["kartustok"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "V_kartustoklist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`V_kartustok`";
	}
	...
	{
		global $Language;
		if ($pageName == "V_kartustokview.php")
			return $Language->phrase("View");
		elseif ($pageName == "V_kartustokedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "V_kartustokadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("V_kartustokview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("V_kartustokview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "V_kartustokadd.php?" . $this->getUrlParm($parm);
		else
			$url = "V_kartustokadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("V_kartustokedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("V_kartustokedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("V_kartustokadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("V_kartustokadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("V_kartustokdelete.php", $this->getUrlParm());
	}
