 ...
 * Page class
 */
class kartustok_add extends kartustok
{
	...
	// Page object name
	public $PageObjName = "kartustok_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_kartustok") !== NULL) {
				...
				$this->setKey("id_kartustok", $this->id_kartustok->CurrentValue); // Set up key
			} else {
				$this->setKey("id_kartustok", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "kartustokview.php")
