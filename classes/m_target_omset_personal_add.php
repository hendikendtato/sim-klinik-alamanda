 ...
 * Page class
 */
class m_target_omset_personal_add extends m_target_omset_personal
{
	...
	// Page object name
	public $PageObjName = "m_target_omset_personal_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_omset_personal") !== NULL) {
				...
				$this->setKey("id_target_omset_personal", $this->id_target_omset_personal->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_omset_personal", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_omset_personalview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_omset_personal->OldValue = $this->id_target_omset_personal->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_omset_personal'] = $this->id_target_omset_personal->CurrentValue;
