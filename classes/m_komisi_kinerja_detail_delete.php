 ...
 * Page class
 */
class m_komisi_kinerja_detail_delete extends m_komisi_kinerja_detail
{
	...
	// Page object name
	public $PageObjName = "m_komisi_kinerja_detail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_komisi_kinerja_detaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_komisi_kinerja_detaillist.php"); // Return to list
			}
		}
	}
