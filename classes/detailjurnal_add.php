 ...
 * Page class
 */
class detailjurnal_add extends detailjurnal
{
	...
	// Page object name
	public $PageObjName = "detailjurnal_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailjurnal") !== NULL) {
				...
				$this->setKey("id_detailjurnal", $this->id_detailjurnal->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailjurnal", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailjurnalview.php")
