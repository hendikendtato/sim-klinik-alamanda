 ...
 * Page class
 */
class m_jadwalpegawai_delete extends m_jadwalpegawai
{
	...
	// Page object name
	public $PageObjName = "m_jadwalpegawai_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_jadwalpegawailist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_jadwalpegawailist.php"); // Return to list
			}
		}
	}
