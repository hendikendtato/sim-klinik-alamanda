 ...
 * Page class
 */
class penyesuaian_poin_add extends penyesuaian_poin
{
	...
	// Page object name
	public $PageObjName = "penyesuaian_poin_add";
	...
	public function run()
	{
		...
		$this->id_penyesuaian_poin->Visible = FALSE;
		$this->kode_penyesuaianpoin->Visible = FALSE;
		...
		if (IsApi()) {
			...
			if (Get("id_penyesuaian_poin") !== NULL) {
				...
				$this->setKey("id_penyesuaian_poin", $this->id_penyesuaian_poin->CurrentValue); // Set up key
			} else {
				$this->setKey("id_penyesuaian_poin", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "penyesuaian_poinview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->kode_penyesuaianpoin->CurrentValue = NULL;
		$this->kode_penyesuaianpoin->OldValue = $this->kode_penyesuaianpoin->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['kode_penyesuaianpoin'] = $this->kode_penyesuaianpoin->CurrentValue;
	...
	protected function validateForm()
	{
		...
		if (in_array("detailpenyesuaianpoin", $detailTblVar) && $GLOBALS["detailpenyesuaianpoin"]->DetailAdd) {
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($addRow) {
			$detailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("detailpenyesuaianpoin", $detailTblVar) && $GLOBALS["detailpenyesuaianpoin"]->DetailAdd) {
				$GLOBALS["detailpenyesuaianpoin"]->pid_penyesuaianpoin->setSessionValue($this->id_penyesuaian_poin->CurrentValue); // Set master key
				if (!isset($GLOBALS["detailpenyesuaianpoin_grid"]))
					$GLOBALS["detailpenyesuaianpoin_grid"] = new detailpenyesuaianpoin_grid(); // Get detail page object
				$Security->loadCurrentUserLevel($this->ProjectID . "detailpenyesuaianpoin"); // Load user level of detail table
				$addRow = $GLOBALS["detailpenyesuaianpoin_grid"]->gridInsert();
				$Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$addRow) {
					$GLOBALS["detailpenyesuaianpoin"]->pid_penyesuaianpoin->setSessionValue(""); // Clear master key if insert failed
				}
			}
		}
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("detailpenyesuaianpoin", $detailTblVar)) {
				...
				if ($GLOBALS["detailpenyesuaianpoin_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["detailpenyesuaianpoin_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["detailpenyesuaianpoin_grid"]->CurrentMode = "add";
					$GLOBALS["detailpenyesuaianpoin_grid"]->CurrentAction = "gridadd";
