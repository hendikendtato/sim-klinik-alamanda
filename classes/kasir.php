...
class kasir
{
	...
	// Table name
	public $TableName = 'kasir.php';

	// Page object name
	public $PageObjName = "kasir";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'kasir.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "kasir", $url, "", "kasir", TRUE);
		$this->Heading = $Language->TablePhrase("kasir", "TblCaption"); 
	}
} // End class
?>