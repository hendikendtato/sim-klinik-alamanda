 ...
 * Page class
 */
class nonjual_delete extends nonjual
{
	...
	// Page object name
	public $PageObjName = "nonjual_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("nonjuallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("nonjuallist.php"); // Return to list
			}
		}
	}
