 ...
 * Page class
 */
class m_target_pasien_view extends m_target_pasien
{
	...
	// Page object name
	public $PageObjName = "m_target_pasien_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("id_target_pasien") !== NULL) {
			$this->RecKey["id_target_pasien"] = Get("id_target_pasien");
			$keyUrl .= "&amp;id_target_pasien=" . urlencode($this->RecKey["id_target_pasien"]);
		}
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("m_target_pasienlist.php"));
				else
		...
		if (Get("id_target_pasien") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_target_pasien");
		}
		...
		$this->id_target_pasien->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_target_pasien") !== NULL) {
				$this->id_target_pasien->setQueryStringValue(Get("id_target_pasien"));
				$this->RecKey["id_target_pasien"] = $this->id_target_pasien->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_target_pasien->setQueryStringValue(Key(0));
				$this->RecKey["id_target_pasien"] = $this->id_target_pasien->QueryStringValue;
			} elseif (Post("id_target_pasien") !== NULL) {
				$this->id_target_pasien->setFormValue(Post("id_target_pasien"));
				$this->RecKey["id_target_pasien"] = $this->id_target_pasien->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_target_pasien->setFormValue(Route(2));
				$this->RecKey["id_target_pasien"] = $this->id_target_pasien->FormValue;
			} else {
				$returnUrl = "m_target_pasienlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_target_pasienlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "m_target_pasienlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_target_pasienview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_target_pasienview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_target_pasienview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("m_target_pasienlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
