 ...
 * Page class
 */
class detailpo_view extends detailpo
{
	...
	// Page object name
	public $PageObjName = "detailpo_view";
	...
	public function __construct()
	{
		...
		if (Get("id_detailpo") !== NULL) {
			$this->RecKey["id_detailpo"] = Get("id_detailpo");
			$keyUrl .= "&amp;id_detailpo=" . urlencode($this->RecKey["id_detailpo"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_detailpo") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_detailpo");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_detailpo") !== NULL) {
				...
				$this->RecKey["id_detailpo"] = $this->id_detailpo->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_detailpo->setQueryStringValue(Key(0));
				$this->RecKey["id_detailpo"] = $this->id_detailpo->QueryStringValue;
			} elseif (Post("id_detailpo") !== NULL) {
				$this->id_detailpo->setFormValue(Post("id_detailpo"));
				$this->RecKey["id_detailpo"] = $this->id_detailpo->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_detailpo->setFormValue(Route(2));
				$this->RecKey["id_detailpo"] = $this->id_detailpo->FormValue;
			} else {
				$returnUrl = "detailpolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "detailpolist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "detailpolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fdetailpoview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fdetailpoview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fdetailpoview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
