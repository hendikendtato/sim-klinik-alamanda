 ...
 * Page class
 */
class detailterimabarang_grid extends detailterimabarang
{
	...
	// Page object name
	public $PageObjName = "detailterimabarang_grid";

	// Grid form hidden field names
	public $FormName = "fdetailterimabaranggrid";
...
// Render list options (extended codes)
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Check referential integrity for master table 'terimabarang'
			$validMasterRecord = TRUE;
			$masterFilter = $this->sqlMasterFilter_terimabarang();
			$keyValue = isset($rsnew['id_terimabarang']) ? $rsnew['id_terimabarang'] : $rsold['id_terimabarang'];
			if (strval($keyValue) != "") {
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "terimabarang") {
			$this->id_terimabarang->Visible = FALSE;
			if ($GLOBALS["terimabarang"]->EventCancelled)
