 ...
 * Page class
 */
class laporan_kas_edit extends laporan_kas
{
	...
	// Page object name
	public $PageObjName = "laporan_kas_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// id_mutasi_kas
			$this->id_mutasi_kas->setDbValueDef($rsnew, $this->id_mutasi_kas->CurrentValue, NULL, $this->id_mutasi_kas->ReadOnly);
