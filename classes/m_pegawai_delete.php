 ...
 * Page class
 */
class m_pegawai_delete extends m_pegawai
{
	...
	// Page object name
	public $PageObjName = "m_pegawai_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_pegawailist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_pegawailist.php"); // Return to list
			}
		}
	}
