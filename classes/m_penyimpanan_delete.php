 ...
 * Page class
 */
class m_penyimpanan_delete extends m_penyimpanan
{
	...
	// Page object name
	public $PageObjName = "m_penyimpanan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_penyimpananlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_penyimpananlist.php"); // Return to list
			}
		}
	}
