 ...
 * Page class
 */
class m_fee_delete extends m_fee
{
	...
	// Page object name
	public $PageObjName = "m_fee_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_feelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_feelist.php"); // Return to list
			}
		}
	}
