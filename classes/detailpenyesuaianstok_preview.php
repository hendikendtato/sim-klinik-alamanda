 ...
 * Page class
 */
class detailpenyesuaianstok_preview extends detailpenyesuaianstok
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianstok_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'detailpenyesuaianstok');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "penyesuaianstok") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=penyesuaianstok&fk_id_penyesuaianstok=" . urlencode(strval($this->pid->QueryStringValue)) . "";
		}
		return $url;
	}
