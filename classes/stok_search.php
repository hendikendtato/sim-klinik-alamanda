 ...
 * Page class
 */
class stok_search extends stok
{
	...
	// Page object name
	public $PageObjName = "stok_search";
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->id_stok); // id_stok
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->id_stok->AdvancedSearch->post())
			$got = TRUE;
