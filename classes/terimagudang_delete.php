 ...
 * Page class
 */
class terimagudang_delete extends terimagudang
{
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("terimagudanglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("terimagudanglist.php"); // Return to list
			}
		}
	}
