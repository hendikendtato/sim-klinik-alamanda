 ...
 * Page class
 */
class rekapstok_view extends rekapstok
{
	...
	// Page object name
	public $PageObjName = "rekapstok_view";
	...
	public function __construct()
	{
		...
		if (Get("id_rekapstok") !== NULL) {
			$this->RecKey["id_rekapstok"] = Get("id_rekapstok");
			$keyUrl .= "&amp;id_rekapstok=" . urlencode($this->RecKey["id_rekapstok"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_rekapstok") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_rekapstok");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_rekapstok") !== NULL) {
				...
				$this->RecKey["id_rekapstok"] = $this->id_rekapstok->QueryStringValue;
				...
				$this->RecKey["id_rekapstok"] = $this->id_rekapstok->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_rekapstok->setFormValue(Route(2));
				$this->RecKey["id_rekapstok"] = $this->id_rekapstok->FormValue;
			} else {
				$returnUrl = "rekapstoklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "rekapstoklist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "rekapstoklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.frekapstokview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.frekapstokview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.frekapstokview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
