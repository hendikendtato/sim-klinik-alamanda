 ...
 * Page class
 */
class detailpromo_add extends detailpromo
{
	...
	// Page object name
	public $PageObjName = "detailpromo_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailpromo") !== NULL) {
				...
				$this->setKey("id_detailpromo", $this->id_detailpromo->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailpromo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailpromoview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_detailpromo->OldValue = $this->id_detailpromo->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_detailpromo'] = $this->id_detailpromo->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_promo
		$this->id_promo->setDbValueDef($rsnew, $this->id_promo->CurrentValue, NULL, FALSE);
