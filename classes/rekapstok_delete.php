 ...
 * Page class
 */
class rekapstok_delete extends rekapstok
{
	...
	// Page object name
	public $PageObjName = "rekapstok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("rekapstoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("rekapstoklist.php"); // Return to list
			}
		}
	}
