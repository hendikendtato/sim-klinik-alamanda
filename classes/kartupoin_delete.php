 ...
 * Page class
 */
class kartupoin_delete extends kartupoin
{
	...
	// Page object name
	public $PageObjName = "kartupoin_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kartupoinlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kartupoinlist.php"); // Return to list
			}
		}
	}
