 ...
 * Page class
 */
class m_akun_delete extends m_akun
{
	...
	// Page object name
	public $PageObjName = "m_akun_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_akunlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_akunlist.php"); // Return to list
			}
		}
	}
