 ...
 * Page class
 */
class detailrekmedpenjualan_search extends detailrekmedpenjualan
{
	...
	// Page object name
	public $PageObjName = "detailrekmedpenjualan_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "detailrekmedpenjualanlist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->id_detailrekmedpenjualan); // id_detailrekmedpenjualan
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->id_detailrekmedpenjualan->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->id_detailrekmedpenjualan->EditValue = HtmlEncode($this->id_detailrekmedpenjualan->AdvancedSearch->SearchValue);
			$this->id_detailrekmedpenjualan->PlaceHolder = RemoveHtml($this->id_detailrekmedpenjualan->caption());
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->id_detailrekmedpenjualan->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_detailrekmedpenjualan->errorMessage());
		}
