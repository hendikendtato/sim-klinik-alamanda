 ...
 * Page class
 */
class purchaseorder_delete extends purchaseorder
{
	...
	// Page object name
	public $PageObjName = "purchaseorder_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("purchaseorderlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("purchaseorderlist.php"); // Return to list
			}
		}
	}
