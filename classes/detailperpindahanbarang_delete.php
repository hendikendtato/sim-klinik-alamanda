 ...
 * Page class
 */
class detailperpindahanbarang_delete extends detailperpindahanbarang
{
	...
	// Page object name
	public $PageObjName = "detailperpindahanbarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailperpindahanbaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailperpindahanbaranglist.php"); // Return to list
			}
		}
	}
