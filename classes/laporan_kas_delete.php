 ...
 * Page class
 */
class laporan_kas_delete extends laporan_kas
{
	...
	// Page object name
	public $PageObjName = "laporan_kas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("laporan_kaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("laporan_kaslist.php"); // Return to list
			}
		}
	}
