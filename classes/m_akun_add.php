 ...
 * Page class
 */
class m_akun_add extends m_akun
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_akun") !== NULL) {
				...
				$this->setKey("id_akun", $this->id_akun->CurrentValue); // Set up key
			} else {
				$this->setKey("id_akun", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_akunview.php")
