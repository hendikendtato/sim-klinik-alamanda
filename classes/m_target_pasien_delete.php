 ...
 * Page class
 */
class m_target_pasien_delete extends m_target_pasien
{
	...
	// Page object name
	public $PageObjName = "m_target_pasien_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_target_pasienlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_target_pasienlist.php"); // Return to list
			}
		}
	}
