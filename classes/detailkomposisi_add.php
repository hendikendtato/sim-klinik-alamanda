 ...
 * Page class
 */
class detailkomposisi_add extends detailkomposisi
{
	...
	// Page object name
	public $PageObjName = "detailkomposisi_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detail_komposisi") !== NULL) {
				...
				$this->setKey("id_detail_komposisi", $this->id_detail_komposisi->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detail_komposisi", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailkomposisiview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_detail_komposisi->OldValue = $this->id_detail_komposisi->CurrentValue;
		$this->id_komposisi->CurrentValue = NULL;
		$this->id_komposisi->OldValue = $this->id_komposisi->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_detail_komposisi'] = $this->id_detail_komposisi->CurrentValue;
		$row['id_komposisi'] = $this->id_komposisi->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_komposisi
		$this->id_komposisi->setDbValueDef($rsnew, $this->id_komposisi->CurrentValue, NULL, FALSE);
