 ...
 * Page class
 */
class returbarang_delete extends returbarang
{
	...
	// Page object name
	public $PageObjName = "returbarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("returbaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("returbaranglist.php"); // Return to list
			}
		}
	}
