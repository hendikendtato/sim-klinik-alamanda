 ...
 * Page class
 */
class view_rm_pasien_search extends view_rm_pasien
{
	...
	// Page object name
	public $PageObjName = "view_rm_pasien_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("view_rm_pasienlist.php"));
				else
		...
		$this->nama_barang->Visible = FALSE;
		$this->harga_jual->Visible = FALSE;
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "view_rm_pasienlist.php" . "?" . $srchStr;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->nama_klinik->Raw)
				$this->nama_klinik->AdvancedSearch->SearchValue = HtmlDecode($this->nama_klinik->AdvancedSearch->SearchValue);
			$this->nama_klinik->EditValue = HtmlEncode($this->nama_klinik->AdvancedSearch->SearchValue);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("view_rm_pasienlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
