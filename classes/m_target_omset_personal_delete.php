 ...
 * Page class
 */
class m_target_omset_personal_delete extends m_target_omset_personal
{
	...
	// Page object name
	public $PageObjName = "m_target_omset_personal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_target_omset_personallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_target_omset_personallist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_target_omset_personal'];
