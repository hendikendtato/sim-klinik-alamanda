 ...
 * Page class
 */
class detailpenyesuaianpoin_view extends detailpenyesuaianpoin
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianpoin_view";
	...
	public function __construct()
	{
		...
		if (Get("id_detailpenyesuaianpoin") !== NULL) {
			$this->RecKey["id_detailpenyesuaianpoin"] = Get("id_detailpenyesuaianpoin");
			$keyUrl .= "&amp;id_detailpenyesuaianpoin=" . urlencode($this->RecKey["id_detailpenyesuaianpoin"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_detailpenyesuaianpoin") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_detailpenyesuaianpoin");
		}
		...
		$this->id_detailpenyesuaianpoin->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_detailpenyesuaianpoin") !== NULL) {
				...
				$this->RecKey["id_detailpenyesuaianpoin"] = $this->id_detailpenyesuaianpoin->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_detailpenyesuaianpoin->setQueryStringValue(Key(0));
				$this->RecKey["id_detailpenyesuaianpoin"] = $this->id_detailpenyesuaianpoin->QueryStringValue;
			} elseif (Post("id_detailpenyesuaianpoin") !== NULL) {
				$this->id_detailpenyesuaianpoin->setFormValue(Post("id_detailpenyesuaianpoin"));
				$this->RecKey["id_detailpenyesuaianpoin"] = $this->id_detailpenyesuaianpoin->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_detailpenyesuaianpoin->setFormValue(Route(2));
				$this->RecKey["id_detailpenyesuaianpoin"] = $this->id_detailpenyesuaianpoin->FormValue;
			} else {
				$returnUrl = "detailpenyesuaianpoinlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "detailpenyesuaianpoinlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "detailpenyesuaianpoinlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fdetailpenyesuaianpoinview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fdetailpenyesuaianpoinview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fdetailpenyesuaianpoinview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
