 ...
 * Page class
 */
class m_klinik_delete extends m_klinik
{
	...
	// Page object name
	public $PageObjName = "m_klinik_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_kliniklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_kliniklist.php"); // Return to list
			}
		}
	}
