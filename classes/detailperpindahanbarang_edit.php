 ...
 * Page class
 */
class detailperpindahanbarang_edit extends detailperpindahanbarang
{
	...
	// Page object name
	public $PageObjName = "detailperpindahanbarang_edit";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("detailperpindahanbaranglist.php"));
				else
		...
		if (IsApi()) {
			...
			// Load key values
			$loaded = TRUE;
			if (Get("id_detailperpindahanbarang") !== NULL) {
				$this->id_detailperpindahanbarang->setQueryStringValue(Get("id_detailperpindahanbarang"));
				$this->id_detailperpindahanbarang->setOldValue($this->id_detailperpindahanbarang->QueryStringValue);
			} elseif (Key(0) !== NULL) {
				$this->id_detailperpindahanbarang->setQueryStringValue(Key(0));
				$this->id_detailperpindahanbarang->setOldValue($this->id_detailperpindahanbarang->QueryStringValue);
			} elseif (Post("id_detailperpindahanbarang") !== NULL) {
				$this->id_detailperpindahanbarang->setFormValue(Post("id_detailperpindahanbarang"));
				$this->id_detailperpindahanbarang->setOldValue($this->id_detailperpindahanbarang->FormValue);
			} elseif (Route(2) !== NULL) {
				$this->id_detailperpindahanbarang->setQueryStringValue(Route(2));
				$this->id_detailperpindahanbarang->setOldValue($this->id_detailperpindahanbarang->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_id_detailperpindahanbarang")) {
					$this->id_detailperpindahanbarang->setFormValue($CurrentForm->getValue("x_id_detailperpindahanbarang"));
				}
			} else {
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("detailperpindahanbaranglist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "detailperpindahanbaranglist.php")
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_detailperpindahanbarang->IsDetailKey)
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("detailperpindahanbaranglist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
