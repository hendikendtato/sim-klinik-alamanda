 ...
 * Page class
 */
class rekapstok_add extends rekapstok
{
	...
	// Page object name
	public $PageObjName = "rekapstok_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_rekapstok") !== NULL) {
				...
				$this->setKey("id_rekapstok", $this->id_rekapstok->CurrentValue); // Set up key
			} else {
				$this->setKey("id_rekapstok", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "rekapstokview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_rekapstok->OldValue = $this->id_rekapstok->CurrentValue;
		...
		$this->masuk_saldoawal->CurrentValue = NULL;
		$this->masuk_saldoawal->OldValue = $this->masuk_saldoawal->CurrentValue;
		$this->masuk_beli->CurrentValue = NULL;
		$this->masuk_beli->OldValue = $this->masuk_beli->CurrentValue;
		$this->masuk_penyesuaian->CurrentValue = NULL;
		$this->masuk_penyesuaian->OldValue = $this->masuk_penyesuaian->CurrentValue;
		$this->keluar_jual->CurrentValue = NULL;
		$this->keluar_jual->OldValue = $this->keluar_jual->CurrentValue;
		$this->keluar_perpindahan->CurrentValue = NULL;
		$this->keluar_perpindahan->OldValue = $this->keluar_perpindahan->CurrentValue;
		$this->keluar_penyesuaian->CurrentValue = NULL;
		$this->keluar_penyesuaian->OldValue = $this->keluar_penyesuaian->CurrentValue;
		$this->keluar_pengembalian->CurrentValue = NULL;
		$this->keluar_pengembalian->OldValue = $this->keluar_pengembalian->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_rekapstok'] = $this->id_rekapstok->CurrentValue;
		$row['id_barang'] = $this->id_barang->CurrentValue;
		$row['tanggal'] = $this->tanggal->CurrentValue;
		$row['masuk_saldoawal'] = $this->masuk_saldoawal->CurrentValue;
		$row['masuk_beli'] = $this->masuk_beli->CurrentValue;
		$row['masuk_penyesuaian'] = $this->masuk_penyesuaian->CurrentValue;
		$row['keluar_jual'] = $this->keluar_jual->CurrentValue;
		$row['keluar_perpindahan'] = $this->keluar_perpindahan->CurrentValue;
		$row['keluar_penyesuaian'] = $this->keluar_penyesuaian->CurrentValue;
		$row['keluar_pengembalian'] = $this->keluar_pengembalian->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// masuk_saldoawal
		$this->masuk_saldoawal->setDbValueDef($rsnew, $this->masuk_saldoawal->CurrentValue, NULL, FALSE);

		// masuk_beli
		$this->masuk_beli->setDbValueDef($rsnew, $this->masuk_beli->CurrentValue, NULL, FALSE);

		// masuk_penyesuaian
		$this->masuk_penyesuaian->setDbValueDef($rsnew, $this->masuk_penyesuaian->CurrentValue, NULL, FALSE);

		// keluar_jual
		$this->keluar_jual->setDbValueDef($rsnew, $this->keluar_jual->CurrentValue, NULL, FALSE);

		// keluar_perpindahan
		$this->keluar_perpindahan->setDbValueDef($rsnew, $this->keluar_perpindahan->CurrentValue, NULL, FALSE);

		// keluar_penyesuaian
		$this->keluar_penyesuaian->setDbValueDef($rsnew, $this->keluar_penyesuaian->CurrentValue, NULL, FALSE);

		// keluar_pengembalian
		$this->keluar_pengembalian->setDbValueDef($rsnew, $this->keluar_pengembalian->CurrentValue, NULL, FALSE);
