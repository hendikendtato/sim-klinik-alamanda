 ...
 * Page class
 */
class m_hargajual_delete extends m_hargajual
{
	...
	// Page object name
	public $PageObjName = "m_hargajual_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_hargajuallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_hargajuallist.php"); // Return to list
			}
		}
	}
