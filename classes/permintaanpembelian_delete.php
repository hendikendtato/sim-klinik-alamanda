 ...
 * Page class
 */
class permintaanpembelian_delete extends permintaanpembelian
{
	...
	// Page object name
	public $PageObjName = "permintaanpembelian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("permintaanpembelianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("permintaanpembelianlist.php"); // Return to list
			}
		}
	}
