...
class _antrian
{
	...
	// Table name
	public $TableName = 'antrian.php';

	// Page object name
	public $PageObjName = "_antrian";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'antrian.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "_antrian", $url, "", "_antrian", TRUE);
		$this->Heading = $Language->TablePhrase("_antrian", "TblCaption"); 
	}
} // End class
?>