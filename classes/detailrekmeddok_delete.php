 ...
 * Page class
 */
class detailrekmeddok_delete extends detailrekmeddok
{
	...
	// Page object name
	public $PageObjName = "detailrekmeddok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailrekmeddoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailrekmeddoklist.php"); // Return to list
			}
		}
	}
