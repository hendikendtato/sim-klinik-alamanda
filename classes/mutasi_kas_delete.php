 ...
 * Page class
 */
class mutasi_kas_delete extends mutasi_kas
{
	...
	// Page object name
	public $PageObjName = "mutasi_kas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mutasi_kaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("mutasi_kaslist.php"); // Return to list
			}
		}
	}
