 ...
 * Page class
 */
class detailrekmedpenjualan_add extends detailrekmedpenjualan
{
	...
	// Page object name
	public $PageObjName = "detailrekmedpenjualan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailrekmedpenjualan") !== NULL) {
				...
				$this->setKey("id_detailrekmedpenjualan", $this->id_detailrekmedpenjualan->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailrekmedpenjualan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailrekmedpenjualanview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_detailrekmedpenjualan->OldValue = $this->id_detailrekmedpenjualan->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_detailrekmedpenjualan'] = $this->id_detailrekmedpenjualan->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_rekmeddok
		$this->id_rekmeddok->setDbValueDef($rsnew, $this->id_rekmeddok->CurrentValue, NULL, FALSE);
