 ...
 * Page class
 */
class detailpo_delete extends detailpo
{
	...
	// Page object name
	public $PageObjName = "detailpo_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailpolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailpolist.php"); // Return to list
			}
		}
	}
