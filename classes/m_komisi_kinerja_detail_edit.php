 ...
 * Page class
 */
class m_komisi_kinerja_detail_edit extends m_komisi_kinerja_detail
{
	...
	// Page object name
	public $PageObjName = "m_komisi_kinerja_detail_edit";
	...
	protected function newRow()
	{
		...
		$row['id_komisi'] = NULL;
		$row['id_barang'] = NULL;
		$row['kinerja_default_persen'] = NULL;
		$row['kinerja_default_rupiah'] = NULL;
		$row['kinerja_target_persen'] = NULL;
		$row['kinerja_target_rupiah'] = NULL;
		$row['tgl_mulai'] = NULL;
		$row['tgl_akhir'] = NULL;
		$row['target'] = NULL;
		return $row;
