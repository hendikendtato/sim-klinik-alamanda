...
class struk_antrian
{
	...
	// Table name
	public $TableName = 'struk_antrian.php';

	// Page object name
	public $PageObjName = "struk_antrian";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'struk_antrian.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "struk_antrian", $url, "", "struk_antrian", TRUE);
		$this->Heading = $Language->TablePhrase("struk_antrian", "TblCaption"); 
	}
} // End class
?>