 ...
 * Page class
 */
class kartupoin_search extends kartupoin
{
	...
	// Page object name
	public $PageObjName = "kartupoin_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "kartupoinlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->id_penyesuaian_poin); // id_penyesuaian_poin
	...
	protected function loadSearchValues()
	{
		...
		if ($this->kode_penjualan->AdvancedSearch->post())
			$got = TRUE;
		if ($this->id_penyesuaian_poin->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->id_penyesuaian_poin->EditValue = HtmlEncode($this->id_penyesuaian_poin->AdvancedSearch->SearchValue);
			$curVal = strval($this->id_penyesuaian_poin->AdvancedSearch->SearchValue);
			if ($curVal != "") {
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->id_penyesuaian_poin->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_penyesuaian_poin->errorMessage());
		}
