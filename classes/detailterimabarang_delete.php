 ...
 * Page class
 */
class detailterimabarang_delete extends detailterimabarang
{
	...
	// Page object name
	public $PageObjName = "detailterimabarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailterimabaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailterimabaranglist.php"); // Return to list
			}
		}
	}
