 ...
 * Page class
 */
class laporan_rekening_delete extends laporan_rekening
{
	...
	// Page object name
	public $PageObjName = "laporan_rekening_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("laporan_rekeninglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("laporan_rekeninglist.php"); // Return to list
			}
		}
	}
