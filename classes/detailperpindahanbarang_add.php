 ...
 * Page class
 */
class detailperpindahanbarang_add extends detailperpindahanbarang
{
	...
	// Page object name
	public $PageObjName = "detailperpindahanbarang_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailperpindahanbarang") !== NULL) {
				...
				$this->setKey("id_detailperpindahanbarang", $this->id_detailperpindahanbarang->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailperpindahanbarang", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailperpindahanbarangview.php")
