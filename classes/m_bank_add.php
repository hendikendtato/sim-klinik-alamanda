 ...
 * Page class
 */
class m_bank_add extends m_bank
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_bank") !== NULL) {
				...
				$this->setKey("id_bank", $this->id_bank->CurrentValue); // Set up key
			} else {
				$this->setKey("id_bank", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_bankview.php")
