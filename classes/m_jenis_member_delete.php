 ...
 * Page class
 */
class m_jenis_member_delete extends m_jenis_member
{
	...
	// Page object name
	public $PageObjName = "m_jenis_member_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_jenis_memberlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_jenis_memberlist.php"); // Return to list
			}
		}
	}
