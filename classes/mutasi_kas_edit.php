 ...
 * Page class
 */
class mutasi_kas_edit extends mutasi_kas
{
	...
	// Page object name
	public $PageObjName = "mutasi_kas_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("detailmutasibank", $detailTblVar) && $GLOBALS["detailmutasibank"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("detailmutasibank", $detailTblVar) && $GLOBALS["detailmutasibank"]->DetailEdit) {
						...
						$editRow = $GLOBALS["detailmutasibank_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("detailmutasibank", $detailTblVar)) {
				...
				if ($GLOBALS["detailmutasibank_grid"]->DetailEdit) {
					$GLOBALS["detailmutasibank_grid"]->CurrentMode = "edit";
					$GLOBALS["detailmutasibank_grid"]->CurrentAction = "gridedit";
