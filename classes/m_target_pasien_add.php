 ...
 * Page class
 */
class m_target_pasien_add extends m_target_pasien
{
	...
	// Page object name
	public $PageObjName = "m_target_pasien_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_pasien") !== NULL) {
				...
				$this->setKey("id_target_pasien", $this->id_target_pasien->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_pasien", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_pasienview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_pasien->OldValue = $this->id_target_pasien->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_pasien'] = $this->id_target_pasien->CurrentValue;
