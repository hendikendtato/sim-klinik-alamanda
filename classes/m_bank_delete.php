 ...
 * Page class
 */
class m_bank_delete extends m_bank
{
	...
	// Page object name
	public $PageObjName = "m_bank_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_banklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_banklist.php"); // Return to list
			}
		}
	}
