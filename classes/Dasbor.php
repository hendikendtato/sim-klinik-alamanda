...
class Dasbor
{
	...
	// Table name
	public $TableName = 'Dasbor.php';

	// Page object name
	public $PageObjName = "Dasbor";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Dasbor.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "Dasbor", $url, "", "Dasbor", TRUE);
		$this->Heading = $Language->TablePhrase("Dasbor", "TblCaption"); 
	}
} // End class
?>