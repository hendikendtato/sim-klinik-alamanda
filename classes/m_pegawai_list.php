 ...
 * Page class
 */
class m_pegawai_list extends m_pegawai
{
	...
	// Page object name
	public $PageObjName = "m_pegawai_list";

	// Grid form hidden field names
	public $FormName = "fm_pegawailist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "m_pegawaiadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "m_pegawaidelete.php";
		$this->MultiUpdateUrl = "m_pegawaiupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fm_pegawailistsrch";
	...
	public function run()
	{
		...
		$this->jenis_pegawai->Visible = FALSE;
		$this->nik_pegawai->setVisibility();
		$this->agama_pegawai->Visible = FALSE;
		$this->tgllahir_pegawai->Visible = FALSE;
		$this->alamat_pegawai->setVisibility();
		$this->hp_pegawai->setVisibility();
		$this->pendidikan_pegawai->Visible = FALSE;
		$this->jurusan_pegawai->Visible = FALSE;
		$this->spesialis_pegawai->setVisibility();
		$this->jabatan_pegawai->setVisibility();
		$this->status_pegawai->Visible = FALSE;
		$this->tarif_pegawai->Visible = FALSE;
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->id_pegawai->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->id_pegawai->OldValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->nik_pegawai->AdvancedSearch->toJson(), ","); // Field nik_pegawai
		$filterList = Concat($filterList, $this->agama_pegawai->AdvancedSearch->toJson(), ","); // Field agama_pegawai
		$filterList = Concat($filterList, $this->tgllahir_pegawai->AdvancedSearch->toJson(), ","); // Field tgllahir_pegawai
		...
		$filterList = Concat($filterList, $this->pendidikan_pegawai->AdvancedSearch->toJson(), ","); // Field pendidikan_pegawai
		$filterList = Concat($filterList, $this->jurusan_pegawai->AdvancedSearch->toJson(), ","); // Field jurusan_pegawai
		$filterList = Concat($filterList, $this->spesialis_pegawai->AdvancedSearch->toJson(), ","); // Field spesialis_pegawai
		$filterList = Concat($filterList, $this->jabatan_pegawai->AdvancedSearch->toJson(), ","); // Field jabatan_pegawai
		$filterList = Concat($filterList, $this->status_pegawai->AdvancedSearch->toJson(), ","); // Field status_pegawai
		$filterList = Concat($filterList, $this->tarif_pegawai->AdvancedSearch->toJson(), ","); // Field tarif_pegawai
		...
		$filterList = Concat($filterList, $this->nilai_komisi->AdvancedSearch->toJson(), ","); // Field nilai_komisi
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fm_pegawailistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field nik_pegawai
		$this->nik_pegawai->AdvancedSearch->SearchValue = @$filter["x_nik_pegawai"];
		$this->nik_pegawai->AdvancedSearch->SearchOperator = @$filter["z_nik_pegawai"];
		$this->nik_pegawai->AdvancedSearch->SearchCondition = @$filter["v_nik_pegawai"];
		$this->nik_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_nik_pegawai"];
		$this->nik_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_nik_pegawai"];
		$this->nik_pegawai->AdvancedSearch->save();

		// Field agama_pegawai
		$this->agama_pegawai->AdvancedSearch->SearchValue = @$filter["x_agama_pegawai"];
		$this->agama_pegawai->AdvancedSearch->SearchOperator = @$filter["z_agama_pegawai"];
		$this->agama_pegawai->AdvancedSearch->SearchCondition = @$filter["v_agama_pegawai"];
		$this->agama_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_agama_pegawai"];
		$this->agama_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_agama_pegawai"];
		$this->agama_pegawai->AdvancedSearch->save();

		// Field tgllahir_pegawai
		$this->tgllahir_pegawai->AdvancedSearch->SearchValue = @$filter["x_tgllahir_pegawai"];
		$this->tgllahir_pegawai->AdvancedSearch->SearchOperator = @$filter["z_tgllahir_pegawai"];
		$this->tgllahir_pegawai->AdvancedSearch->SearchCondition = @$filter["v_tgllahir_pegawai"];
		$this->tgllahir_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_tgllahir_pegawai"];
		$this->tgllahir_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_tgllahir_pegawai"];
		$this->tgllahir_pegawai->AdvancedSearch->save();
		...
		// Field pendidikan_pegawai
		$this->pendidikan_pegawai->AdvancedSearch->SearchValue = @$filter["x_pendidikan_pegawai"];
		$this->pendidikan_pegawai->AdvancedSearch->SearchOperator = @$filter["z_pendidikan_pegawai"];
		$this->pendidikan_pegawai->AdvancedSearch->SearchCondition = @$filter["v_pendidikan_pegawai"];
		$this->pendidikan_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_pendidikan_pegawai"];
		$this->pendidikan_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_pendidikan_pegawai"];
		$this->pendidikan_pegawai->AdvancedSearch->save();

		// Field jurusan_pegawai
		$this->jurusan_pegawai->AdvancedSearch->SearchValue = @$filter["x_jurusan_pegawai"];
		$this->jurusan_pegawai->AdvancedSearch->SearchOperator = @$filter["z_jurusan_pegawai"];
		$this->jurusan_pegawai->AdvancedSearch->SearchCondition = @$filter["v_jurusan_pegawai"];
		$this->jurusan_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_jurusan_pegawai"];
		$this->jurusan_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_jurusan_pegawai"];
		$this->jurusan_pegawai->AdvancedSearch->save();

		// Field spesialis_pegawai
		$this->spesialis_pegawai->AdvancedSearch->SearchValue = @$filter["x_spesialis_pegawai"];
		$this->spesialis_pegawai->AdvancedSearch->SearchOperator = @$filter["z_spesialis_pegawai"];
		$this->spesialis_pegawai->AdvancedSearch->SearchCondition = @$filter["v_spesialis_pegawai"];
		$this->spesialis_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_spesialis_pegawai"];
		$this->spesialis_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_spesialis_pegawai"];
		$this->spesialis_pegawai->AdvancedSearch->save();

		// Field jabatan_pegawai
		$this->jabatan_pegawai->AdvancedSearch->SearchValue = @$filter["x_jabatan_pegawai"];
		$this->jabatan_pegawai->AdvancedSearch->SearchOperator = @$filter["z_jabatan_pegawai"];
		$this->jabatan_pegawai->AdvancedSearch->SearchCondition = @$filter["v_jabatan_pegawai"];
		$this->jabatan_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_jabatan_pegawai"];
		$this->jabatan_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_jabatan_pegawai"];
		$this->jabatan_pegawai->AdvancedSearch->save();
		...
		// Field tarif_pegawai
		$this->tarif_pegawai->AdvancedSearch->SearchValue = @$filter["x_tarif_pegawai"];
		$this->tarif_pegawai->AdvancedSearch->SearchOperator = @$filter["z_tarif_pegawai"];
		$this->tarif_pegawai->AdvancedSearch->SearchCondition = @$filter["v_tarif_pegawai"];
		$this->tarif_pegawai->AdvancedSearch->SearchValue2 = @$filter["y_tarif_pegawai"];
		$this->tarif_pegawai->AdvancedSearch->SearchOperator2 = @$filter["w_tarif_pegawai"];
		$this->tarif_pegawai->AdvancedSearch->save();
		...
		// Field nilai_komisi
		$this->nilai_komisi->AdvancedSearch->SearchValue = @$filter["x_nilai_komisi"];
		$this->nilai_komisi->AdvancedSearch->SearchOperator = @$filter["z_nilai_komisi"];
		$this->nilai_komisi->AdvancedSearch->SearchCondition = @$filter["v_nilai_komisi"];
		$this->nilai_komisi->AdvancedSearch->SearchValue2 = @$filter["y_nilai_komisi"];
		$this->nilai_komisi->AdvancedSearch->SearchOperator2 = @$filter["w_nilai_komisi"];
		$this->nilai_komisi->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->nik_pegawai, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->pendidikan_pegawai, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->jurusan_pegawai, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->spesialis_pegawai, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->nik_pegawai); // nik_pegawai
			$this->updateSort($this->alamat_pegawai); // alamat_pegawai
			$this->updateSort($this->hp_pegawai); // hp_pegawai
			$this->updateSort($this->spesialis_pegawai); // spesialis_pegawai
			$this->updateSort($this->jabatan_pegawai); // jabatan_pegawai
			$this->updateSort($this->id_klinik); // id_klinik
			$this->updateSort($this->nilai_komisi); // nilai_komisi
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->nik_pegawai->setSort("");
				$this->alamat_pegawai->setSort("");
				$this->hp_pegawai->setSort("");
				$this->spesialis_pegawai->setSort("");
				$this->jabatan_pegawai->setSort("");
				$this->id_klinik->setSort("");
				$this->nilai_komisi->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fm_pegawailistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fm_pegawailistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fm_pegawailist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function newRow()
	{
		...
		$row['nik_pegawai'] = NULL;
		$row['agama_pegawai'] = NULL;
		$row['tgllahir_pegawai'] = NULL;
		$row['alamat_pegawai'] = NULL;
		$row['hp_pegawai'] = NULL;
		$row['pendidikan_pegawai'] = NULL;
		$row['jurusan_pegawai'] = NULL;
		$row['spesialis_pegawai'] = NULL;
		$row['jabatan_pegawai'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_pegawailist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_pegawailist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_pegawailist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_m_pegawai" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_m_pegawai\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fm_pegawailist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fm_pegawailistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
