 ...
 * Page class
 */
class detailrekmedterapis_add extends detailrekmedterapis
{
	...
	// Page object name
	public $PageObjName = "detailrekmedterapis_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailrekmedterapis") !== NULL) {
				...
				$this->setKey("id_detailrekmedterapis", $this->id_detailrekmedterapis->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailrekmedterapis", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailrekmedterapisview.php")
