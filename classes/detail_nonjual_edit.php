 ...
 * Page class
 */
class detail_nonjual_edit extends detail_nonjual
{
	...
	// Page object name
	public $PageObjName = "detail_nonjual_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// id_nonjual
			$this->id_nonjual->setDbValueDef($rsnew, $this->id_nonjual->CurrentValue, NULL, $this->id_nonjual->ReadOnly);
