 ...
 * Page class
 */
class m_pelanggan_view extends m_pelanggan
{
	...
	// Page object name
	public $PageObjName = "m_pelanggan_view";
	...
	public function __construct()
	{
		...
		if (Get("id_pelanggan") !== NULL) {
			$this->RecKey["id_pelanggan"] = Get("id_pelanggan");
			$keyUrl .= "&amp;id_pelanggan=" . urlencode($this->RecKey["id_pelanggan"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_pelanggan") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_pelanggan");
		}
		...
		$this->tgl_terakhir_transaksi->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_pelanggan") !== NULL) {
				...
				$this->RecKey["id_pelanggan"] = $this->id_pelanggan->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_pelanggan->setQueryStringValue(Key(0));
				$this->RecKey["id_pelanggan"] = $this->id_pelanggan->QueryStringValue;
			} elseif (Post("id_pelanggan") !== NULL) {
				$this->id_pelanggan->setFormValue(Post("id_pelanggan"));
				$this->RecKey["id_pelanggan"] = $this->id_pelanggan->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_pelanggan->setFormValue(Route(2));
				$this->RecKey["id_pelanggan"] = $this->id_pelanggan->FormValue;
			} else {
				$returnUrl = "m_pelangganlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_pelangganlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "m_pelangganlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_pelangganview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_pelangganview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_pelangganview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
