 ...
 * Page class
 */
class detailrekmeddok_add extends detailrekmeddok
{
	...
	// Page object name
	public $PageObjName = "detailrekmeddok_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_pemobat") !== NULL) {
				...
				$this->setKey("id_pemobat", $this->id_pemobat->CurrentValue); // Set up key
			} else {
				$this->setKey("id_pemobat", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailrekmeddokview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_pemobat->OldValue = $this->id_pemobat->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_pemobat'] = $this->id_pemobat->CurrentValue;
