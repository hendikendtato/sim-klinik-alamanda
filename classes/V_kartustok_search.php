 ...
 * Page class
 */
class V_kartustok_search extends V_kartustok
{
	...
	// Page object name
	public $PageObjName = "V_kartustok_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("V_kartustoklist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "V_kartustoklist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("V_kartustoklist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
