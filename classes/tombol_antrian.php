...
class tombol_antrian
{
	...
	// Table name
	public $TableName = 'tombol_antrian.php';

	// Page object name
	public $PageObjName = "tombol_antrian";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'tombol_antrian.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "tombol_antrian", $url, "", "tombol_antrian", TRUE);
		$this->Heading = $Language->TablePhrase("tombol_antrian", "TblCaption"); 
	}
} // End class
?>