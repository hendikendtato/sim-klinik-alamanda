...
/**
 * Table class for detailrekmeddok
 */
class detailrekmeddok extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'detailrekmeddok';
		$this->TableName = 'detailrekmeddok';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`detailrekmeddok`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id_pemobat
		$this->id_pemobat = new DbField('detailrekmeddok', 'detailrekmeddok', 'x_id_pemobat', 'id_pemobat', '`id_pemobat`', '`id_pemobat`', 3, 11, -1, FALSE, '`id_pemobat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// id_rekmeddok
		$this->id_rekmeddok = new DbField('detailrekmeddok', 'detailrekmeddok', 'x_id_rekmeddok', 'id_rekmeddok', '`id_rekmeddok`', '`id_rekmeddok`', 19, 11, -1, FALSE, '`id_rekmeddok`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_barang
		$this->id_barang = new DbField('detailrekmeddok', 'detailrekmeddok', 'x_id_barang', 'id_barang', '`id_barang`', '`id_barang`', 3, 11, -1, FALSE, '`id_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_barang->Sortable = TRUE; // Allow sort
		$this->id_barang->Lookup = new Lookup('id_barang', 'm_barang', FALSE, 'id', ["kode_barang","nama_barang","",""], [], [], [], [], ["satuan"], ["x_satuan"], '', '');
		$this->id_barang->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['id_barang'] = &$this->id_barang;

		// jumlah
		$this->jumlah = new DbField('detailrekmeddok', 'detailrekmeddok', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 5, 22, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jumlah->Sortable = TRUE; // Allow sort
		$this->jumlah->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['jumlah'] = &$this->jumlah;

		// satuan
		$this->satuan = new DbField('detailrekmeddok', 'detailrekmeddok', 'x_satuan', 'satuan', '`satuan`', '`satuan`', 3, 11, -1, FALSE, '`satuan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->satuan->Lookup = new Lookup('satuan', 'm_satuan_barang', FALSE, 'id_satuan', ["kode_satuan","nama_satuan","",""], [], [], [], [], [], [], '', '');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`detailrekmeddok`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "detailrekmeddoklist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "detailrekmeddokedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "detailrekmeddokadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("detailrekmeddokview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("detailrekmeddokview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "detailrekmeddokadd.php?" . $this->getUrlParm($parm);
		else
			$url = "detailrekmeddokadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("detailrekmeddokedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("detailrekmeddokadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("detailrekmeddokdelete.php", $this->getUrlParm());
	}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->id_pemobat->CurrentValue = $key;
			else
				$this->id_pemobat->OldValue = $key;
