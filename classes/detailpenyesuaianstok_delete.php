 ...
 * Page class
 */
class detailpenyesuaianstok_delete extends detailpenyesuaianstok
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianstok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailpenyesuaianstoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailpenyesuaianstoklist.php"); // Return to list
			}
		}
	}
