 ...
 * Page class
 */
class detailpenyesuaianstok_add extends detailpenyesuaianstok
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianstok_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailpenyesuaianstokview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		if (strval($this->pid->CurrentValue) != "") {
			$masterFilter = str_replace("@id_penyesuaianstok@", AdjustSql($this->pid->CurrentValue, "DB"), $masterFilter);
		} else {
		...
		// pid
		$this->pid->setDbValueDef($rsnew, $this->pid->CurrentValue, 0, strval($this->pid->CurrentValue) == "");
