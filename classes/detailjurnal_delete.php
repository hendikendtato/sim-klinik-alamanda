 ...
 * Page class
 */
class detailjurnal_delete extends detailjurnal
{
	...
	// Page object name
	public $PageObjName = "detailjurnal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailjurnallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailjurnallist.php"); // Return to list
			}
		}
	}
