...
class _komposisi
{
	...
	// Table name
	public $TableName = 'komposisi.php';

	// Page object name
	public $PageObjName = "_komposisi";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'komposisi.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "_komposisi", $url, "", "_komposisi", TRUE);
		$this->Heading = $Language->TablePhrase("_komposisi", "TblCaption"); 
	}
} // End class
?>