 ...
 * Page class
 */
class kirimbarang_delete extends kirimbarang
{
	...
	// Page object name
	public $PageObjName = "kirimbarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kirimbaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kirimbaranglist.php"); // Return to list
			}
		}
	}
