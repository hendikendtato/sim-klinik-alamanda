...
/**
 * Table class for v_stokbarang
 */
class v_stokbarang extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_stokbarang';
		$this->TableName = 'v_stokbarang';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`v_stokbarang`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id_barang
		$this->id_barang = new DbField('v_stokbarang', 'v_stokbarang', 'x_id_barang', 'id_barang', '`id_barang`', '`id_barang`', 3, 11, -1, FALSE, '`id_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_barang
		$this->nama_barang = new DbField('v_stokbarang', 'v_stokbarang', 'x_nama_barang', 'nama_barang', '`nama_barang`', '`nama_barang`', 200, 255, -1, FALSE, '`nama_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_barang->Sortable = TRUE; // Allow sort
		$this->fields['nama_barang'] = &$this->nama_barang;

		// jumlah
		$this->jumlah = new DbField('v_stokbarang', 'v_stokbarang', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 5, 11, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_stokbarang`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_stokbarangview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_stokbarangedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_stokbarangadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_stokbarangview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_stokbarangview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_stokbarangadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_stokbarangadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_stokbarangedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_stokbarangadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_stokbarangdelete.php", $this->getUrlParm());
	}
