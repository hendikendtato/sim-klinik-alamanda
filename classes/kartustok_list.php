 ...
 * Page class
 */
class kartustok_list extends kartustok
{
	...
	// Page object name
	public $PageObjName = "kartustok_list";

	// Grid form hidden field names
	public $FormName = "fkartustoklist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "kartustokdelete.php";
		$this->MultiUpdateUrl = "kartustokupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fkartustoklistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->id_terimabarang->AdvancedSearch->toJson(), ","); // Field id_terimabarang
		...
		$filterList = Concat($filterList, $this->id_retur->AdvancedSearch->toJson(), ","); // Field id_retur
		$filterList = Concat($filterList, $this->id_penyesuaian->AdvancedSearch->toJson(), ","); // Field id_penyesuaian
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fkartustoklistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field id_terimabarang
		$this->id_terimabarang->AdvancedSearch->SearchValue = @$filter["x_id_terimabarang"];
		$this->id_terimabarang->AdvancedSearch->SearchOperator = @$filter["z_id_terimabarang"];
		$this->id_terimabarang->AdvancedSearch->SearchCondition = @$filter["v_id_terimabarang"];
		$this->id_terimabarang->AdvancedSearch->SearchValue2 = @$filter["y_id_terimabarang"];
		$this->id_terimabarang->AdvancedSearch->SearchOperator2 = @$filter["w_id_terimabarang"];
		$this->id_terimabarang->AdvancedSearch->save();
		...
		$this->id_penjualan->AdvancedSearch->SearchCondition = @$filter["v_id_penjualan"];
		$this->id_penjualan->AdvancedSearch->SearchValue2 = @$filter["y_id_penjualan"];
		$this->id_penjualan->AdvancedSearch->SearchOperator2 = @$filter["w_id_penjualan"];
		$this->id_penjualan->AdvancedSearch->save();
		...
		// Field id_nonjual
		$this->id_nonjual->AdvancedSearch->SearchValue = @$filter["x_id_nonjual"];
		$this->id_nonjual->AdvancedSearch->SearchOperator = @$filter["z_id_nonjual"];
		$this->id_nonjual->AdvancedSearch->SearchCondition = @$filter["v_id_nonjual"];
		$this->id_nonjual->AdvancedSearch->SearchValue2 = @$filter["y_id_nonjual"];
		$this->id_nonjual->AdvancedSearch->SearchOperator2 = @$filter["w_id_nonjual"];
		$this->id_nonjual->AdvancedSearch->save();

		// Field id_retur
		$this->id_retur->AdvancedSearch->SearchValue = @$filter["x_id_retur"];
		$this->id_retur->AdvancedSearch->SearchOperator = @$filter["z_id_retur"];
		$this->id_retur->AdvancedSearch->SearchCondition = @$filter["v_id_retur"];
		$this->id_retur->AdvancedSearch->SearchValue2 = @$filter["y_id_retur"];
		$this->id_retur->AdvancedSearch->SearchOperator2 = @$filter["w_id_retur"];
		$this->id_retur->AdvancedSearch->save();

		// Field id_penyesuaian
		$this->id_penyesuaian->AdvancedSearch->SearchValue = @$filter["x_id_penyesuaian"];
		$this->id_penyesuaian->AdvancedSearch->SearchOperator = @$filter["z_id_penyesuaian"];
		$this->id_penyesuaian->AdvancedSearch->SearchCondition = @$filter["v_id_penyesuaian"];
		$this->id_penyesuaian->AdvancedSearch->SearchValue2 = @$filter["y_id_penyesuaian"];
		$this->id_penyesuaian->AdvancedSearch->SearchOperator2 = @$filter["w_id_penyesuaian"];
		$this->id_penyesuaian->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->id_terimabarang, $default, FALSE); // id_terimabarang
		...
		$this->buildSearchSql($where, $this->id_retur, $default, FALSE); // id_retur
		$this->buildSearchSql($where, $this->id_penyesuaian, $default, FALSE); // id_penyesuaian
		...
		if (!$default && $this->Command == "search") {
			...
			$this->id_terimabarang->AdvancedSearch->save(); // id_terimabarang
			...
			$this->id_retur->AdvancedSearch->save(); // id_retur
			$this->id_penyesuaian->AdvancedSearch->save(); // id_penyesuaian
		}
		return $where;
	}
	...
	protected function checkSearchParms()
	{
		...
		if ($this->tanggal->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->id_terimabarang->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->id_kirimbarang->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->id_nonjual->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->id_retur->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->id_penyesuaian->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->id_terimabarang->AdvancedSearch->unsetSession();
		...
		$this->id_retur->AdvancedSearch->unsetSession();
		$this->id_penyesuaian->AdvancedSearch->unsetSession();
	}
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_kartustok->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fkartustoklistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkartustoklistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fkartustoklist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// id_terimabarang
		if (!$this->isAddOrEdit() && $this->id_terimabarang->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_terimabarang->AdvancedSearch->SearchValue != "" || $this->id_terimabarang->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		if (!$this->isAddOrEdit() && $this->id_penjualan->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_penjualan->AdvancedSearch->SearchValue != "" || $this->id_penjualan->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// id_kirimbarang
		if (!$this->isAddOrEdit() && $this->id_kirimbarang->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_kirimbarang->AdvancedSearch->SearchValue != "" || $this->id_kirimbarang->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// id_nonjual
		if (!$this->isAddOrEdit() && $this->id_nonjual->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_nonjual->AdvancedSearch->SearchValue != "" || $this->id_nonjual->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// id_retur
		if (!$this->isAddOrEdit() && $this->id_retur->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_retur->AdvancedSearch->SearchValue != "" || $this->id_retur->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// id_penyesuaian
		if (!$this->isAddOrEdit() && $this->id_penyesuaian->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->id_penyesuaian->AdvancedSearch->SearchValue != "" || $this->id_penyesuaian->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		return $got;
	}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fkartustoklist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fkartustoklist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fkartustoklist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_kartustok" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_kartustok\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fkartustoklist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fkartustoklistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"kartustoksrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"kartustok\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'kartustoksrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
