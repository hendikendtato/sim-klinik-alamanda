 ...
 * Page class
 */
class m_barang_delete extends m_barang
{
	...
	// Page object name
	public $PageObjName = "m_barang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_baranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_baranglist.php"); // Return to list
			}
		}
	}
