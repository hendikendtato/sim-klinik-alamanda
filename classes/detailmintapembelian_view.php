 ...
 * Page class
 */
class detailmintapembelian_view extends detailmintapembelian
{
	...
	// Page object name
	public $PageObjName = "detailmintapembelian_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("id_detailpp") !== NULL) {
			$this->RecKey["id_detailpp"] = Get("id_detailpp");
			$keyUrl .= "&amp;id_detailpp=" . urlencode($this->RecKey["id_detailpp"]);
		}
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("detailmintapembelianlist.php"));
				else
		...
		if (Get("id_detailpp") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_detailpp");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_detailpp") !== NULL) {
				$this->id_detailpp->setQueryStringValue(Get("id_detailpp"));
				$this->RecKey["id_detailpp"] = $this->id_detailpp->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_detailpp->setQueryStringValue(Key(0));
				$this->RecKey["id_detailpp"] = $this->id_detailpp->QueryStringValue;
			} elseif (Post("id_detailpp") !== NULL) {
				$this->id_detailpp->setFormValue(Post("id_detailpp"));
				$this->RecKey["id_detailpp"] = $this->id_detailpp->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_detailpp->setFormValue(Route(2));
				$this->RecKey["id_detailpp"] = $this->id_detailpp->FormValue;
			} else {
				$returnUrl = "detailmintapembelianlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "detailmintapembelianlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "detailmintapembelianlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fdetailmintapembelianview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fdetailmintapembelianview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fdetailmintapembelianview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("detailmintapembelianlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
