 ...
 * Page class
 */
class m_pegawai_edit extends m_pegawai
{
	...
	// Page object name
	public $PageObjName = "m_pegawai_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_pegawai") !== NULL) {
				...
				$this->id_pegawai->setQueryStringValue(Key(0));
				$this->id_pegawai->setOldValue($this->id_pegawai->QueryStringValue);
				...
				$this->id_pegawai->setQueryStringValue(Route(2));
				$this->id_pegawai->setOldValue($this->id_pegawai->QueryStringValue);
			} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// nama_pegawai
			$this->nama_pegawai->setDbValueDef($rsnew, $this->nama_pegawai->CurrentValue, NULL, $this->nama_pegawai->ReadOnly);

			// nama_lengkap
			$this->nama_lengkap->setDbValueDef($rsnew, $this->nama_lengkap->CurrentValue, NULL, $this->nama_lengkap->ReadOnly);

			// jenis_pegawai
			$this->jenis_pegawai->setDbValueDef($rsnew, $this->jenis_pegawai->CurrentValue, NULL, $this->jenis_pegawai->ReadOnly);

			// nik_pegawai
			$this->nik_pegawai->setDbValueDef($rsnew, $this->nik_pegawai->CurrentValue, NULL, $this->nik_pegawai->ReadOnly);

			// agama_pegawai
			$this->agama_pegawai->setDbValueDef($rsnew, $this->agama_pegawai->CurrentValue, NULL, $this->agama_pegawai->ReadOnly);

			// tgllahir_pegawai
			$this->tgllahir_pegawai->setDbValueDef($rsnew, UnFormatDateTime($this->tgllahir_pegawai->CurrentValue, 0), NULL, $this->tgllahir_pegawai->ReadOnly);

			// alamat_pegawai
			$this->alamat_pegawai->setDbValueDef($rsnew, $this->alamat_pegawai->CurrentValue, NULL, $this->alamat_pegawai->ReadOnly);

			// hp_pegawai
			$this->hp_pegawai->setDbValueDef($rsnew, $this->hp_pegawai->CurrentValue, NULL, $this->hp_pegawai->ReadOnly);

			// pendidikan_pegawai
			$this->pendidikan_pegawai->setDbValueDef($rsnew, $this->pendidikan_pegawai->CurrentValue, NULL, $this->pendidikan_pegawai->ReadOnly);

			// jurusan_pegawai
			$this->jurusan_pegawai->setDbValueDef($rsnew, $this->jurusan_pegawai->CurrentValue, NULL, $this->jurusan_pegawai->ReadOnly);

			// spesialis_pegawai
			$this->spesialis_pegawai->setDbValueDef($rsnew, $this->spesialis_pegawai->CurrentValue, NULL, $this->spesialis_pegawai->ReadOnly);

			// jabatan_pegawai
			$this->jabatan_pegawai->setDbValueDef($rsnew, $this->jabatan_pegawai->CurrentValue, NULL, $this->jabatan_pegawai->ReadOnly);

			// status_pegawai
			$this->status_pegawai->setDbValueDef($rsnew, $this->status_pegawai->CurrentValue, NULL, $this->status_pegawai->ReadOnly);

			// tarif_pegawai
			$this->tarif_pegawai->setDbValueDef($rsnew, $this->tarif_pegawai->CurrentValue, NULL, $this->tarif_pegawai->ReadOnly);
