 ...
 * Page class
 */
class m_target_omset_cabang_delete extends m_target_omset_cabang
{
	...
	// Page object name
	public $PageObjName = "m_target_omset_cabang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_target_omset_cabanglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_target_omset_cabanglist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_target_omset_cabang'];
