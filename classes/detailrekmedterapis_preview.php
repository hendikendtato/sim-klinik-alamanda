 ...
 * Page class
 */
class detailrekmedterapis_preview extends detailrekmedterapis
{
	...
	// Page object name
	public $PageObjName = "detailrekmedterapis_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'detailrekmedterapis');
			if ($Security->isLoggedIn())
