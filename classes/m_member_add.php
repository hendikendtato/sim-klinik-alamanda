 ...
 * Page class
 */
class m_member_add extends m_member
{
	...
	// Page object name
	public $PageObjName = "m_member_add";
	...
	public function run()
	{
		...
		$this->poin_member->Visible = FALSE;
		$this->tgl_awal_transaksi->Visible = FALSE;
		$this->total_akumulasi->Visible = FALSE;
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_memberview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->kode_member->CurrentValue = NULL;
		$this->kode_member->OldValue = $this->kode_member->CurrentValue;
		...
		$this->jenis_member->CurrentValue = NULL;
		$this->jenis_member->OldValue = $this->jenis_member->CurrentValue;
		...
		$this->tgl_awal_transaksi->CurrentValue = NULL;
		$this->tgl_awal_transaksi->OldValue = $this->tgl_awal_transaksi->CurrentValue;
		$this->total_akumulasi->CurrentValue = NULL;
		$this->total_akumulasi->OldValue = $this->total_akumulasi->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['kode_member'] = $this->kode_member->CurrentValue;
		$row['id_klinik'] = $this->id_klinik->CurrentValue;
		$row['id_pelanggan'] = $this->id_pelanggan->CurrentValue;
		$row['jenis_member'] = $this->jenis_member->CurrentValue;
		...
		$row['tgl_awal_transaksi'] = $this->tgl_awal_transaksi->CurrentValue;
		$row['total_akumulasi'] = $this->total_akumulasi->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// kode_member
		$this->kode_member->setDbValueDef($rsnew, $this->kode_member->CurrentValue, NULL, FALSE);
		...
		// tgl_mulai
		$this->tgl_mulai->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_mulai->CurrentValue, 7), NULL, FALSE);

		// tgl_akhir
		$this->tgl_akhir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_akhir->CurrentValue, 7), NULL, FALSE);
