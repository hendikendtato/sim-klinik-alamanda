...
class kartu
{
	...
	// Table name
	public $TableName = 'kartu.php';

	// Page object name
	public $PageObjName = "kartu";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'kartu.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "kartu", $url, "", "kartu", TRUE);
		$this->Heading = $Language->TablePhrase("kartu", "TblCaption"); 
	}
} // End class
?>