 ...
 * Page class
 */
class rekmeddokter_delete extends rekmeddokter
{
	...
	// Page object name
	public $PageObjName = "rekmeddokter_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("rekmeddokterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("rekmeddokterlist.php"); // Return to list
			}
		}
	}
