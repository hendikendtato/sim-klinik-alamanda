 ...
 * Page class
 */
class m_pelanggan_delete extends m_pelanggan
{
	...
	// Page object name
	public $PageObjName = "m_pelanggan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_pelangganlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_pelangganlist.php"); // Return to list
			}
		}
	}
