 ...
 * Page class
 */
class detailrekmedterapis_search extends detailrekmedterapis
{
	...
	// Page object name
	public $PageObjName = "detailrekmedterapis_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "detailrekmedterapislist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->id_detailrekmedterapis); // id_detailrekmedterapis
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->id_detailrekmedterapis->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->id_detailrekmedterapis->EditValue = HtmlEncode($this->id_detailrekmedterapis->AdvancedSearch->SearchValue);
			$this->id_detailrekmedterapis->PlaceHolder = RemoveHtml($this->id_detailrekmedterapis->caption());
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->id_detailrekmedterapis->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_detailrekmedterapis->errorMessage());
		}
