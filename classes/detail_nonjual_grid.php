 ...
 * Page class
 */
class detail_nonjual_grid extends detail_nonjual
{
	...
	// Page object name
	public $PageObjName = "detail_nonjual_grid";

	// Grid form hidden field names
	public $FormName = "fdetail_nonjualgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_id_nonjual") && $CurrentForm->hasValue("o_id_nonjual") && $this->id_nonjual->CurrentValue != $this->id_nonjual->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_id_nonjual"))
			$this->id_nonjual->setOldValue($CurrentForm->getValue("o_id_nonjual"));
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "nonjual") {
			...
			if ($GLOBALS["nonjual"]->EventCancelled)
