...
class userlevels extends DbTable
{
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("userlevelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("userlevelsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "userlevelsadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("userlevelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("userlevelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("userlevelsdelete.php", $this->getUrlParm());
	}
