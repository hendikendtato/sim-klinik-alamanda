 ...
 * Page class
 */
class m_target_produk_add extends m_target_produk
{
	...
	// Page object name
	public $PageObjName = "m_target_produk_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_produk") !== NULL) {
				...
				$this->setKey("id_target_produk", $this->id_target_produk->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_produk", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_produkview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_produk->OldValue = $this->id_target_produk->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_produk'] = $this->id_target_produk->CurrentValue;
