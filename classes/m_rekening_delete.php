 ...
 * Page class
 */
class m_rekening_delete extends m_rekening
{
	...
	// Page object name
	public $PageObjName = "m_rekening_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_rekeninglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_rekeninglist.php"); // Return to list
			}
		}
	}
