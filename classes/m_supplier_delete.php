 ...
 * Page class
 */
class m_supplier_delete extends m_supplier
{
	...
	// Page object name
	public $PageObjName = "m_supplier_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_supplierlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_supplierlist.php"); // Return to list
			}
		}
	}
