 ...
 * Page class
 */
class detailmintapembelian_add extends detailmintapembelian
{
	...
	// Page object name
	public $PageObjName = "detailmintapembelian_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailpp") !== NULL) {
				...
				$this->setKey("id_detailpp", $this->id_detailpp->CurrentValue); // Set up key
			} else {
				$this->setKey("id_detailpp", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "detailmintapembelianview.php")
