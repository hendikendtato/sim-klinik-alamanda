...
class rekap
{
	...
	// Table name
	public $TableName = 'rekap.php';

	// Page object name
	public $PageObjName = "rekap";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'rekap.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "rekap", $url, "", "rekap", TRUE);
		$this->Heading = $Language->TablePhrase("rekap", "TblCaption"); 
	}
} // End class
?>