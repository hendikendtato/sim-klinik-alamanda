 ...
 * Page class
 */
class view_hargajual_list extends view_hargajual
{
	...
	// Table name
	public $TableName = 'view_hargajual';

	// Page object name
	public $PageObjName = "view_hargajual_list";

	// Grid form hidden field names
	public $FormName = "fview_hargajuallist";
	...
	public function __construct()
	{
		...
		// Table object (view_hargajual)
		if (!isset($GLOBALS["view_hargajual"]) || get_class($GLOBALS["view_hargajual"]) == PROJECT_NAMESPACE . "view_hargajual") {
			$GLOBALS["view_hargajual"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["view_hargajual"];
		}
		...
		$this->AddUrl = "view_hargajualadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_hargajualdelete.php";
		$this->MultiUpdateUrl = "view_hargajualupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_hargajual');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fview_hargajuallistsrch";
	...
	public function run()
	{
		...
		$this->alamat_klinik->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->alamat_klinik->AdvancedSearch->toJson(), ","); // Field alamat_klinik
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fview_hargajuallistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field subkategori
		$this->subkategori->AdvancedSearch->SearchValue = @$filter["x_subkategori"];
		$this->subkategori->AdvancedSearch->SearchOperator = @$filter["z_subkategori"];
		$this->subkategori->AdvancedSearch->SearchCondition = @$filter["v_subkategori"];
		$this->subkategori->AdvancedSearch->SearchValue2 = @$filter["y_subkategori"];
		...
		$this->id_hargajual->AdvancedSearch->SearchCondition = @$filter["v_id_hargajual"];
		$this->id_hargajual->AdvancedSearch->SearchValue2 = @$filter["y_id_hargajual"];
		$this->id_hargajual->AdvancedSearch->SearchOperator2 = @$filter["w_id_hargajual"];
		$this->id_hargajual->AdvancedSearch->save();
		...
		// Field telpon_klinik
		$this->telpon_klinik->AdvancedSearch->SearchValue = @$filter["x_telpon_klinik"];
		$this->telpon_klinik->AdvancedSearch->SearchOperator = @$filter["z_telpon_klinik"];
		$this->telpon_klinik->AdvancedSearch->SearchCondition = @$filter["v_telpon_klinik"];
		$this->telpon_klinik->AdvancedSearch->SearchValue2 = @$filter["y_telpon_klinik"];
		$this->telpon_klinik->AdvancedSearch->SearchOperator2 = @$filter["w_telpon_klinik"];
		$this->telpon_klinik->AdvancedSearch->save();

		// Field alamat_klinik
		$this->alamat_klinik->AdvancedSearch->SearchValue = @$filter["x_alamat_klinik"];
		$this->alamat_klinik->AdvancedSearch->SearchOperator = @$filter["z_alamat_klinik"];
		$this->alamat_klinik->AdvancedSearch->SearchCondition = @$filter["v_alamat_klinik"];
		$this->alamat_klinik->AdvancedSearch->SearchValue2 = @$filter["y_alamat_klinik"];
		$this->alamat_klinik->AdvancedSearch->SearchOperator2 = @$filter["w_alamat_klinik"];
		$this->alamat_klinik->AdvancedSearch->save();

		// Field foto_klinik
		$this->foto_klinik->AdvancedSearch->SearchValue = @$filter["x_foto_klinik"];
		$this->foto_klinik->AdvancedSearch->SearchOperator = @$filter["z_foto_klinik"];
		$this->foto_klinik->AdvancedSearch->SearchCondition = @$filter["v_foto_klinik"];
		$this->foto_klinik->AdvancedSearch->SearchValue2 = @$filter["y_foto_klinik"];
		$this->foto_klinik->AdvancedSearch->SearchOperator2 = @$filter["w_foto_klinik"];
		$this->foto_klinik->AdvancedSearch->save();
		...
		// Field komposisi
		$this->komposisi->AdvancedSearch->SearchValue = @$filter["x_komposisi"];
		$this->komposisi->AdvancedSearch->SearchOperator = @$filter["z_komposisi"];
		$this->komposisi->AdvancedSearch->SearchCondition = @$filter["v_komposisi"];
		...
		// Field tgl_exp
		$this->tgl_exp->AdvancedSearch->SearchValue = @$filter["x_tgl_exp"];
		$this->tgl_exp->AdvancedSearch->SearchOperator = @$filter["z_tgl_exp"];
		$this->tgl_exp->AdvancedSearch->SearchCondition = @$filter["v_tgl_exp"];
		$this->tgl_exp->AdvancedSearch->SearchValue2 = @$filter["y_tgl_exp"];
		$this->tgl_exp->AdvancedSearch->SearchOperator2 = @$filter["w_tgl_exp"];
		$this->tgl_exp->AdvancedSearch->save();

		// Field disc_rp
		$this->disc_rp->AdvancedSearch->SearchValue = @$filter["x_disc_rp"];
		$this->disc_rp->AdvancedSearch->SearchOperator = @$filter["z_disc_rp"];
		$this->disc_rp->AdvancedSearch->SearchCondition = @$filter["v_disc_rp"];
		$this->disc_rp->AdvancedSearch->SearchValue2 = @$filter["y_disc_rp"];
		$this->disc_rp->AdvancedSearch->SearchOperator2 = @$filter["w_disc_rp"];
		$this->disc_rp->AdvancedSearch->save();

		// Field disc_pr
		$this->disc_pr->AdvancedSearch->SearchValue = @$filter["x_disc_pr"];
		$this->disc_pr->AdvancedSearch->SearchOperator = @$filter["z_disc_pr"];
		$this->disc_pr->AdvancedSearch->SearchCondition = @$filter["v_disc_pr"];
		$this->disc_pr->AdvancedSearch->SearchValue2 = @$filter["y_disc_pr"];
		$this->disc_pr->AdvancedSearch->SearchOperator2 = @$filter["w_disc_pr"];
		$this->disc_pr->AdvancedSearch->save();
		...
		$this->discontinue->AdvancedSearch->SearchCondition = @$filter["v_discontinue"];
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->nama_klinik, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->telpon_klinik, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->alamat_klinik, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->foto_klinik, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_hargajuallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_hargajuallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fview_hargajuallist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->alamat_klinik->setDbValue($row['alamat_klinik']);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview_hargajuallist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview_hargajuallist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview_hargajuallist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_view_hargajual" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_view_hargajual\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fview_hargajuallist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_hargajuallistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
