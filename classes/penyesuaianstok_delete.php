 ...
 * Page class
 */
class penyesuaianstok_delete extends penyesuaianstok
{
	...
	// Page object name
	public $PageObjName = "penyesuaianstok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("penyesuaianstoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("penyesuaianstoklist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_penyesuaianstok'];
