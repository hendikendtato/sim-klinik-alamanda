 ...
 * Page class
 */
class m_jadwalpegawai_view extends m_jadwalpegawai
{
	...
	// Page object name
	public $PageObjName = "m_jadwalpegawai_view";
	...
	public function __construct()
	{
		...
		if (Get("id_jadwalpeg") !== NULL) {
			$this->RecKey["id_jadwalpeg"] = Get("id_jadwalpeg");
			$keyUrl .= "&amp;id_jadwalpeg=" . urlencode($this->RecKey["id_jadwalpeg"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_jadwalpeg") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_jadwalpeg");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_jadwalpeg") !== NULL) {
				...
				$this->RecKey["id_jadwalpeg"] = $this->id_jadwalpeg->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_jadwalpeg->setQueryStringValue(Key(0));
				$this->RecKey["id_jadwalpeg"] = $this->id_jadwalpeg->QueryStringValue;
			} elseif (Post("id_jadwalpeg") !== NULL) {
				$this->id_jadwalpeg->setFormValue(Post("id_jadwalpeg"));
				$this->RecKey["id_jadwalpeg"] = $this->id_jadwalpeg->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_jadwalpeg->setFormValue(Route(2));
				$this->RecKey["id_jadwalpeg"] = $this->id_jadwalpeg->FormValue;
			} else {
				$returnUrl = "m_jadwalpegawailist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_jadwalpegawailist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "m_jadwalpegawailist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_jadwalpegawaiview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_jadwalpegawaiview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_jadwalpegawaiview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
