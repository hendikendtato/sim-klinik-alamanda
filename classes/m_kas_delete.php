 ...
 * Page class
 */
class m_kas_delete extends m_kas
{
	...
	// Page object name
	public $PageObjName = "m_kas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_kaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_kaslist.php"); // Return to list
			}
		}
	}
