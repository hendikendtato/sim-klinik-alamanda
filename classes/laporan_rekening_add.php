 ...
 * Page class
 */
class laporan_rekening_add extends laporan_rekening
{
	...
	// Page object name
	public $PageObjName = "laporan_rekening_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "laporan_rekeningview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_rekening
		$this->id_rekening->setDbValueDef($rsnew, $this->id_rekening->CurrentValue, 0, FALSE);
