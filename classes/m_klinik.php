...
/**
 * Table class for m_klinik
 */
class m_klinik extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'm_klinik';
		$this->TableName = 'm_klinik';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_klinik`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id_klinik
		$this->id_klinik = new DbField('m_klinik', 'm_klinik', 'x_id_klinik', 'id_klinik', '`id_klinik`', '`id_klinik`', 19, 11, -1, FALSE, '`id_klinik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama_klinik
		$this->nama_klinik = new DbField('m_klinik', 'm_klinik', 'x_nama_klinik', 'nama_klinik', '`nama_klinik`', '`nama_klinik`', 200, 255, -1, FALSE, '`nama_klinik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_klinik->Sortable = TRUE; // Allow sort
		$this->fields['nama_klinik'] = &$this->nama_klinik;

		// telpon_klinik
		$this->telpon_klinik = new DbField('m_klinik', 'm_klinik', 'x_telpon_klinik', 'telpon_klinik', '`telpon_klinik`', '`telpon_klinik`', 201, 65535, -1, FALSE, '`telpon_klinik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->telpon_klinik->Sortable = TRUE; // Allow sort
		$this->fields['telpon_klinik'] = &$this->telpon_klinik;

		// alamat_klinik
		$this->alamat_klinik = new DbField('m_klinik', 'm_klinik', 'x_alamat_klinik', 'alamat_klinik', '`alamat_klinik`', '`alamat_klinik`', 201, 65535, -1, FALSE, '`alamat_klinik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->alamat_klinik->Sortable = TRUE; // Allow sort
		$this->fields['alamat_klinik'] = &$this->alamat_klinik;

		// foto_klinik
		$this->foto_klinik = new DbField('m_klinik', 'm_klinik', 'x_foto_klinik', 'foto_klinik', '`foto_klinik`', '`foto_klinik`', 200, 255, -1, FALSE, '`foto_klinik`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_klinik`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "m_klinikedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "m_klinikadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("m_klinikview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("m_klinikview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "m_klinikadd.php?" . $this->getUrlParm($parm);
		else
			$url = "m_klinikadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_klinikedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("m_klinikadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("m_klinikdelete.php", $this->getUrlParm());
	}
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->id_klinik->CurrentValue = $key;
			else
				$this->id_klinik->OldValue = $key;
