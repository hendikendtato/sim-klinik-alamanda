 ...
 * Page class
 */
class m_klinik_view extends m_klinik
{
	...
	// Page object name
	public $PageObjName = "m_klinik_view";
	...
	public function __construct()
	{
		...
		if (Get("id_klinik") !== NULL) {
			$this->RecKey["id_klinik"] = Get("id_klinik");
			$keyUrl .= "&amp;id_klinik=" . urlencode($this->RecKey["id_klinik"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_klinik") !== NULL) {
				...
				$this->RecKey["id_klinik"] = $this->id_klinik->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_klinik->setQueryStringValue(Key(0));
				$this->RecKey["id_klinik"] = $this->id_klinik->QueryStringValue;
			} elseif (Post("id_klinik") !== NULL) {
				$this->id_klinik->setFormValue(Post("id_klinik"));
				$this->RecKey["id_klinik"] = $this->id_klinik->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_klinik->setFormValue(Route(2));
				$this->RecKey["id_klinik"] = $this->id_klinik->FormValue;
			} else {
				$returnUrl = "m_kliniklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_kliniklist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "m_kliniklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_klinikview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_klinikview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_klinikview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
