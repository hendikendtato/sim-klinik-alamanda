 ...
 * Page class
 */
class detailperpindahanbarang_search extends detailperpindahanbarang
{
	...
	// Page object name
	public $PageObjName = "detailperpindahanbarang_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "detailperpindahanbaranglist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->id_detailperpindahanbarang); // id_detailperpindahanbarang
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->id_detailperpindahanbarang->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->id_detailperpindahanbarang->EditValue = HtmlEncode($this->id_detailperpindahanbarang->AdvancedSearch->SearchValue);
			$this->id_detailperpindahanbarang->PlaceHolder = RemoveHtml($this->id_detailperpindahanbarang->caption());
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->id_detailperpindahanbarang->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_detailperpindahanbarang->errorMessage());
		}
