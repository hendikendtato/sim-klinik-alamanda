 ...
 * Page class
 */
class rekapstok_search extends rekapstok
{
	...
	// Page object name
	public $PageObjName = "rekapstok_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "rekapstoklist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->id_rekapstok); // id_rekapstok
		$this->buildSearchUrl($srchUrl, $this->id_barang); // id_barang
		$this->buildSearchUrl($srchUrl, $this->tanggal); // tanggal
		$this->buildSearchUrl($srchUrl, $this->masuk_saldoawal); // masuk_saldoawal
		$this->buildSearchUrl($srchUrl, $this->masuk_beli); // masuk_beli
		$this->buildSearchUrl($srchUrl, $this->masuk_penyesuaian); // masuk_penyesuaian
		$this->buildSearchUrl($srchUrl, $this->keluar_jual); // keluar_jual
		$this->buildSearchUrl($srchUrl, $this->keluar_perpindahan); // keluar_perpindahan
		$this->buildSearchUrl($srchUrl, $this->keluar_penyesuaian); // keluar_penyesuaian
		$this->buildSearchUrl($srchUrl, $this->keluar_pengembalian); // keluar_pengembalian
		$this->buildSearchUrl($srchUrl, $this->stok); // stok
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->id_rekapstok->AdvancedSearch->post())
			$got = TRUE;
		if ($this->id_barang->AdvancedSearch->post())
			$got = TRUE;
		if ($this->tanggal->AdvancedSearch->post())
			$got = TRUE;
		if ($this->masuk_saldoawal->AdvancedSearch->post())
			$got = TRUE;
		if ($this->masuk_beli->AdvancedSearch->post())
			$got = TRUE;
		if ($this->masuk_penyesuaian->AdvancedSearch->post())
			$got = TRUE;
		if ($this->keluar_jual->AdvancedSearch->post())
			$got = TRUE;
		if ($this->keluar_perpindahan->AdvancedSearch->post())
			$got = TRUE;
		if ($this->keluar_penyesuaian->AdvancedSearch->post())
			$got = TRUE;
		if ($this->keluar_pengembalian->AdvancedSearch->post())
			$got = TRUE;
		if ($this->stok->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->id_rekapstok->EditValue = HtmlEncode($this->id_rekapstok->AdvancedSearch->SearchValue);
			$this->id_rekapstok->PlaceHolder = RemoveHtml($this->id_rekapstok->caption());
			...
			$this->masuk_saldoawal->EditValue = HtmlEncode($this->masuk_saldoawal->AdvancedSearch->SearchValue);
			...
			$this->masuk_beli->EditValue = HtmlEncode($this->masuk_beli->AdvancedSearch->SearchValue);
			...
			$this->masuk_penyesuaian->EditValue = HtmlEncode($this->masuk_penyesuaian->AdvancedSearch->SearchValue);
			...
			$this->keluar_jual->EditValue = HtmlEncode($this->keluar_jual->AdvancedSearch->SearchValue);
			...
			$this->keluar_perpindahan->EditValue = HtmlEncode($this->keluar_perpindahan->AdvancedSearch->SearchValue);
			...
			$this->keluar_penyesuaian->EditValue = HtmlEncode($this->keluar_penyesuaian->AdvancedSearch->SearchValue);
			...
			$this->keluar_pengembalian->EditValue = HtmlEncode($this->keluar_pengembalian->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckInteger($this->id_rekapstok->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_rekapstok->errorMessage());
		}
		...
		if (!CheckNumber($this->masuk_saldoawal->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->masuk_saldoawal->errorMessage());
		}
		if (!CheckNumber($this->masuk_beli->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->masuk_beli->errorMessage());
		}
		if (!CheckNumber($this->masuk_penyesuaian->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->masuk_penyesuaian->errorMessage());
		}
		if (!CheckNumber($this->keluar_jual->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->keluar_jual->errorMessage());
		}
		if (!CheckNumber($this->keluar_perpindahan->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->keluar_perpindahan->errorMessage());
		}
		if (!CheckNumber($this->keluar_penyesuaian->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->keluar_penyesuaian->errorMessage());
		}
		if (!CheckNumber($this->keluar_pengembalian->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->keluar_pengembalian->errorMessage());
		}
		if (!CheckNumber($this->stok->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->stok->errorMessage());
		}
