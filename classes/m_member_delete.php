 ...
 * Page class
 */
class m_member_delete extends m_member
{
	...
	// Page object name
	public $PageObjName = "m_member_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_memberlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_memberlist.php"); // Return to list
			}
		}
	}
