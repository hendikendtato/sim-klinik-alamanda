 ...
 * Page class
 */
class kartupoin_view extends kartupoin
{
	...
	// Page object name
	public $PageObjName = "kartupoin_view";
	...
	public function __construct()
	{
		...
		if (Get("id_kartupoin") !== NULL) {
			$this->RecKey["id_kartupoin"] = Get("id_kartupoin");
			$keyUrl .= "&amp;id_kartupoin=" . urlencode($this->RecKey["id_kartupoin"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_kartupoin") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_kartupoin");
		}
		...
		$this->id_kartupoin->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_kartupoin") !== NULL) {
				...
				$this->RecKey["id_kartupoin"] = $this->id_kartupoin->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->id_kartupoin->setQueryStringValue(Key(0));
				$this->RecKey["id_kartupoin"] = $this->id_kartupoin->QueryStringValue;
			} elseif (Post("id_kartupoin") !== NULL) {
				$this->id_kartupoin->setFormValue(Post("id_kartupoin"));
				$this->RecKey["id_kartupoin"] = $this->id_kartupoin->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_kartupoin->setFormValue(Route(2));
				$this->RecKey["id_kartupoin"] = $this->id_kartupoin->FormValue;
			} else {
				$returnUrl = "kartupoinlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "kartupoinlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "kartupoinlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fkartupoinview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fkartupoinview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fkartupoinview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
