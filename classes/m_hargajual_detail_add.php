 ...
 * Page class
 */
class m_hargajual_detail_add extends m_hargajual_detail
{
	...
	// Page object name
	public $PageObjName = "m_hargajual_detail_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_hargajualdetail") !== NULL) {
				...
				$this->setKey("id_hargajualdetail", $this->id_hargajualdetail->CurrentValue); // Set up key
			} else {
				$this->setKey("id_hargajualdetail", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_hargajual_detailview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_hargajualdetail->OldValue = $this->id_hargajualdetail->CurrentValue;
		...
		$this->hargajual->CurrentValue = NULL;
		$this->hargajual->OldValue = $this->hargajual->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_hargajualdetail'] = $this->id_hargajualdetail->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// hargajual
		$this->hargajual->setDbValueDef($rsnew, $this->hargajual->CurrentValue, NULL, FALSE);
