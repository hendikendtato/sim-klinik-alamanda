 ...
 * Page class
 */
class m_target_perawatan_add extends m_target_perawatan
{
	...
	// Page object name
	public $PageObjName = "m_target_perawatan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_perawatan") !== NULL) {
				...
				$this->setKey("id_target_perawatan", $this->id_target_perawatan->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_perawatan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_perawatanview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_perawatan->OldValue = $this->id_target_perawatan->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_perawatan'] = $this->id_target_perawatan->CurrentValue;
