 ...
 * Page class
 */
class detailmintapembelian_delete extends detailmintapembelian
{
	...
	// Page object name
	public $PageObjName = "detailmintapembelian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailmintapembelianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailmintapembelianlist.php"); // Return to list
			}
		}
	}
