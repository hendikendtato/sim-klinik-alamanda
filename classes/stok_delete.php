 ...
 * Page class
 */
class stok_delete extends stok
{
	...
	// Page object name
	public $PageObjName = "stok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("stoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("stoklist.php"); // Return to list
			}
		}
	}
