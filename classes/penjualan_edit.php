 ...
 * Page class
 */
class penjualan_edit extends penjualan
{
	...
	protected function validateForm()
	{
		...
		if (in_array("detailpenjualan", $detailTblVar) && $GLOBALS["detailpenjualan"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("detailpenjualan", $detailTblVar) && $GLOBALS["detailpenjualan"]->DetailEdit) {
						...
						$editRow = $GLOBALS["detailpenjualan_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("detailpenjualan", $detailTblVar)) {
				...
				if ($GLOBALS["detailpenjualan_grid"]->DetailEdit) {
					$GLOBALS["detailpenjualan_grid"]->CurrentMode = "edit";
					$GLOBALS["detailpenjualan_grid"]->CurrentAction = "gridedit";
	...
	function Page_DataRendering(&$header) {
		...
		$value = $this->total->CurrentValue;
		$value1 = str_replace(".", "", $value);
		$this->total->EditValue = $value1;
