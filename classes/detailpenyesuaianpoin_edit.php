 ...
 * Page class
 */
class detailpenyesuaianpoin_edit extends detailpenyesuaianpoin
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianpoin_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_detailpenyesuaianpoin") !== NULL) {
				...
				$this->id_detailpenyesuaianpoin->setOldValue($this->id_detailpenyesuaianpoin->QueryStringValue);
			} elseif (Key(0) !== NULL) {
				...
				$this->id_detailpenyesuaianpoin->setOldValue($this->id_detailpenyesuaianpoin->FormValue);
			} elseif (Route(2) !== NULL) {
				$this->id_detailpenyesuaianpoin->setQueryStringValue(Route(2));
				$this->id_detailpenyesuaianpoin->setOldValue($this->id_detailpenyesuaianpoin->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_id_detailpenyesuaianpoin")) {
					$this->id_detailpenyesuaianpoin->setFormValue($CurrentForm->getValue("x_id_detailpenyesuaianpoin"));
				}
			} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_detailpenyesuaianpoin->IsDetailKey)
