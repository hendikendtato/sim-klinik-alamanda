 ...
 * Page class
 */
class m_komisi_delete extends m_komisi
{
	...
	// Page object name
	public $PageObjName = "m_komisi_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_komisilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_komisilist.php"); // Return to list
			}
		}
	}
