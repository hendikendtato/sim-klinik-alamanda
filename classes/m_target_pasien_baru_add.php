 ...
 * Page class
 */
class m_target_pasien_baru_add extends m_target_pasien_baru
{
	...
	// Page object name
	public $PageObjName = "m_target_pasien_baru_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_pasien_baru") !== NULL) {
				...
				$this->setKey("id_target_pasien_baru", $this->id_target_pasien_baru->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_pasien_baru", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_pasien_baruview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_pasien_baru->OldValue = $this->id_target_pasien_baru->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_pasien_baru'] = $this->id_target_pasien_baru->CurrentValue;
