 ...
 * Page class
 */
class m_rekening_add extends m_rekening
{
	...
	// Page object name
	public $PageObjName = "m_rekening_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_rekening") !== NULL) {
				...
				$this->setKey("id_rekening", $this->id_rekening->CurrentValue); // Set up key
			} else {
				$this->setKey("id_rekening", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_rekeningview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_rekening->OldValue = $this->id_rekening->CurrentValue;
		...
		$this->nomor_rekening->CurrentValue = NULL;
		$this->nomor_rekening->OldValue = $this->nomor_rekening->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_rekening'] = $this->id_rekening->CurrentValue;
		$row['id_bank'] = $this->id_bank->CurrentValue;
		$row['id_klinik'] = $this->id_klinik->CurrentValue;
		$row['nama_rekening'] = $this->nama_rekening->CurrentValue;
		$row['nomor_rekening'] = $this->nomor_rekening->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// nomor_rekening
		$this->nomor_rekening->setDbValueDef($rsnew, $this->nomor_rekening->CurrentValue, NULL, FALSE);
