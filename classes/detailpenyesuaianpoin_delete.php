 ...
 * Page class
 */
class detailpenyesuaianpoin_delete extends detailpenyesuaianpoin
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianpoin_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("detailpenyesuaianpoinlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("detailpenyesuaianpoinlist.php"); // Return to list
			}
		}
	}
