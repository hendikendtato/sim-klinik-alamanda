 ...
 * Page class
 */
class detailpenyesuaianstok_grid extends detailpenyesuaianstok
{
	...
	// Page object name
	public $PageObjName = "detailpenyesuaianstok_grid";

	// Grid form hidden field names
	public $FormName = "fdetailpenyesuaianstokgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		$this->stokdatabase->FormValue = ""; // Clear form value
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_id_barang") && $CurrentForm->hasValue("o_id_barang") && $this->id_barang->CurrentValue != $this->id_barang->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_stokdatabase") && $CurrentForm->hasValue("o_stokdatabase") && $this->stokdatabase->CurrentValue != $this->stokdatabase->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->stokdatabase->CurrentValue = NULL;
		$this->stokdatabase->OldValue = $this->stokdatabase->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_stokdatabase"))
			$this->stokdatabase->setOldValue($CurrentForm->getValue("o_stokdatabase"));
	...
	protected function newRow()
	{
		...
		$row['stokdatabase'] = $this->stokdatabase->CurrentValue;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (strval($this->stokdatabase->EditValue) != "" && is_numeric($this->stokdatabase->EditValue)) {
				...
				$this->stokdatabase->OldValue = $this->stokdatabase->EditValue;
			}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'detailpenyesuaianstok'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_penyesuaianstok();
		if ($this->pid->getSessionValue() != "") {
			$masterFilter = str_replace("@id_penyesuaianstok@", AdjustSql($this->pid->getSessionValue(), "DB"), $masterFilter);
		} else {
			$validMasterRecord = FALSE;
		}
		if ($validMasterRecord) {
		...
		// stokdatabase
		$this->stokdatabase->setDbValueDef($rsnew, $this->stokdatabase->CurrentValue, NULL, FALSE);
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "penyesuaianstok") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["penyesuaianstok"]->EventCancelled)
