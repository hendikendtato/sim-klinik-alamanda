 ...
 * Page class
 */
class m_target_kunjungan_add extends m_target_kunjungan
{
	...
	// Page object name
	public $PageObjName = "m_target_kunjungan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_target_kunjungan") !== NULL) {
				...
				$this->setKey("id_target_kunjungan", $this->id_target_kunjungan->CurrentValue); // Set up key
			} else {
				$this->setKey("id_target_kunjungan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "m_target_kunjunganview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_target_kunjungan->OldValue = $this->id_target_kunjungan->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_target_kunjungan'] = $this->id_target_kunjungan->CurrentValue;
