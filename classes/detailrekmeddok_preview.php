 ...
 * Page class
 */
class detailrekmeddok_preview extends detailrekmeddok
{
	...
	// Page object name
	public $PageObjName = "detailrekmeddok_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'detailrekmeddok');
			if ($Security->isLoggedIn())
