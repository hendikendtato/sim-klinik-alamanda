 ...
 * Page class
 */
class penjualan_copy_add extends penjualan_copy
{
	...
	// Page object name
	public $PageObjName = "penjualan_copy_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "penjualan_copyview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->diskon_persen->CurrentValue = NULL;
		$this->diskon_persen->OldValue = $this->diskon_persen->CurrentValue;
		$this->diskon_rupiah->CurrentValue = NULL;
		$this->diskon_rupiah->OldValue = $this->diskon_rupiah->CurrentValue;
		...
		$this->jumlah_voucher->CurrentValue = NULL;
		$this->jumlah_voucher->OldValue = $this->jumlah_voucher->CurrentValue;
		...
		$this->ongkir->CurrentValue = NULL;
		$this->ongkir->OldValue = $this->ongkir->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['jumlah_voucher'] = $this->jumlah_voucher->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// waktu
		$this->waktu->setDbValueDef($rsnew, UnFormatDateTime($this->waktu->CurrentValue, 0), CurrentDate(), FALSE);
		...
		// kode_penjualan
		$this->kode_penjualan->setDbValueDef($rsnew, $this->kode_penjualan->CurrentValue, "", FALSE);
