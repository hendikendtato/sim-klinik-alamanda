 ...
 * Page class
 */
class m_komisi_recall_detail_preview extends m_komisi_recall_detail
{
	...
	// Page object name
	public $PageObjName = "m_komisi_recall_detail_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'm_komisi_recall_detail');
			if ($Security->isLoggedIn())
