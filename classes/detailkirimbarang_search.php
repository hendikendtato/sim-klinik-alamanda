 ...
 * Page class
 */
class detailkirimbarang_search extends detailkirimbarang
{
	...
	// Page object name
	public $PageObjName = "detailkirimbarang_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "detailkirimbaranglist.php" . "?" . $srchStr;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$curVal = strval($this->id_satuan->AdvancedSearch->SearchValue);
			if ($curVal != "") {
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->id_satuan->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->id_satuan->errorMessage());
		}
