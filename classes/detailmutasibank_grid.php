 ...
 * Page class
 */
class detailmutasibank_grid extends detailmutasibank
{
	...
	// Page object name
	public $PageObjName = "detailmutasibank_grid";

	// Grid form hidden field names
	public $FormName = "fdetailmutasibankgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_akun_id") && $CurrentForm->hasValue("o_akun_id") && $this->akun_id->CurrentValue != $this->akun_id->OldValue)
			return FALSE;
		...
		if ($CurrentForm->hasValue("x_keterangan") && $CurrentForm->hasValue("o_keterangan") && $this->keterangan->CurrentValue != $this->keterangan->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_tipe_mutasi") && $CurrentForm->hasValue("o_tipe_mutasi") && $this->tipe_mutasi->CurrentValue != $this->tipe_mutasi->OldValue)
			return FALSE;
		return TRUE;
	}
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_akun_id"))
			$this->akun_id->setOldValue($CurrentForm->getValue("o_akun_id"));
		...
		if ($CurrentForm->hasValue("o_tipe_mutasi"))
			$this->tipe_mutasi->setOldValue($CurrentForm->getValue("o_tipe_mutasi"));
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tipe_mutasi
			$this->tipe_mutasi->setDbValueDef($rsnew, $this->tipe_mutasi->CurrentValue, NULL, $this->tipe_mutasi->ReadOnly);
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "mutasi_kas") {
			$this->pid->Visible = FALSE;
			if ($GLOBALS["mutasi_kas"]->EventCancelled)
