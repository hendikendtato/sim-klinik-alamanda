 ...
 * Page class
 */
class m_target_omset_personal_view extends m_target_omset_personal
{
	...
	// Page object name
	public $PageObjName = "m_target_omset_personal_view";
	...
	public function __construct()
	{
		...
		if (Get("id_target_omset_personal") !== NULL) {
			$this->RecKey["id_target_omset_personal"] = Get("id_target_omset_personal");
			$keyUrl .= "&amp;id_target_omset_personal=" . urlencode($this->RecKey["id_target_omset_personal"]);
		}
	...
	public function run()
	{
		...
		if (Get("id_target_omset_personal") !== NULL) {
			if ($ExportFileName != "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("id_target_omset_personal");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_target_omset_personal") !== NULL) {
				...
				$this->RecKey["id_target_omset_personal"] = $this->id_target_omset_personal->QueryStringValue;
				...
				$this->RecKey["id_target_omset_personal"] = $this->id_target_omset_personal->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->id_target_omset_personal->setFormValue(Route(2));
				$this->RecKey["id_target_omset_personal"] = $this->id_target_omset_personal->FormValue;
			} else {
				$returnUrl = "m_target_omset_personallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_target_omset_personallist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "m_target_omset_personallist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fm_target_omset_personalview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fm_target_omset_personalview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fm_target_omset_personalview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
