...
class upload_data
{
	...
	// Table name
	public $TableName = 'upload_data.php';

	// Page object name
	public $PageObjName = "upload_data";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'upload_data.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "upload_data", $url, "", "upload_data", TRUE);
		$this->Heading = $Language->TablePhrase("upload_data", "TblCaption"); 
	}
} // End class
?>