 ...
 * Page class
 */
class detailkirimbarang_add extends detailkirimbarang
{
	...
	// Page object name
	public $PageObjName = "detailkirimbarang_add";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("detailkirimbaranglist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("detailkirimbaranglist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "detailkirimbaranglist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "detailkirimbarangview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_barang
		$this->id_barang->setDbValueDef($rsnew, $this->id_barang->CurrentValue, NULL, strval($this->id_barang->CurrentValue) == "");

		// id_satuan
		$this->id_satuan->setDbValueDef($rsnew, $this->id_satuan->CurrentValue, NULL, strval($this->id_satuan->CurrentValue) == "");
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("detailkirimbaranglist.php"), "", $this->TableVar, TRUE);
