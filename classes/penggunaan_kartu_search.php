 ...
 * Page class
 */
class penggunaan_kartu_search extends penggunaan_kartu
{
	...
	// Page object name
	public $PageObjName = "penggunaan_kartu_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("penggunaan_kartulist.php"));
				else
		...
		$this->jenis_kartu->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "penggunaan_kartulist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->jenis_kartu); // jenis_kartu
	...
	protected function loadSearchValues()
	{
		...
		if ($this->tgl->AdvancedSearch->post())
			$got = TRUE;
		if ($this->jenis_kartu->AdvancedSearch->post())
			$got = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->jenis_kartu->Raw)
				$this->jenis_kartu->AdvancedSearch->SearchValue = HtmlDecode($this->jenis_kartu->AdvancedSearch->SearchValue);
			$this->jenis_kartu->EditValue = HtmlEncode($this->jenis_kartu->AdvancedSearch->SearchValue);
			...
			if (!$this->charge->Raw)
				$this->charge->AdvancedSearch->SearchValue = HtmlDecode($this->charge->AdvancedSearch->SearchValue);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("penggunaan_kartulist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
