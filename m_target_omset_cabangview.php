...
<?php } ?>
<?php if ($m_target_omset_cabang_view->created->Visible) { // created ?>
	<tr id="r_created">
		<td class="<?php echo $m_target_omset_cabang_view->TableLeftColumnClass ?>"><span id="elh_m_target_omset_cabang_created"><?php echo $m_target_omset_cabang_view->created->caption() ?></span></td>
		<td data-name="created" <?php echo $m_target_omset_cabang_view->created->cellAttributes() ?>>
<span id="el_m_target_omset_cabang_created">
<span<?php echo $m_target_omset_cabang_view->created->viewAttributes() ?>><?php echo $m_target_omset_cabang_view->created->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_target_omset_cabang_view->updated->Visible) { // updated ?>
	<tr id="r_updated">
		<td class="<?php echo $m_target_omset_cabang_view->TableLeftColumnClass ?>"><span id="elh_m_target_omset_cabang_updated"><?php echo $m_target_omset_cabang_view->updated->caption() ?></span></td>
		<td data-name="updated" <?php echo $m_target_omset_cabang_view->updated->cellAttributes() ?>>
<span id="el_m_target_omset_cabang_updated">
<span<?php echo $m_target_omset_cabang_view->updated->viewAttributes() ?>><?php echo $m_target_omset_cabang_view->updated->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
