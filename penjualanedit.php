...
loadjs.ready("head", function() {
	...
	fpenjualanedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php } ?>
			<?php if ($penjualan_edit->status_void->Required) { ?>
				elm = this.getElements("x" + infix + "_status_void");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $penjualan_edit->status_void->caption(), $penjualan_edit->status_void->RequiredErrorMessage)) ?>");
			<?php } ?>
...
loadjs.ready("head", function() {
	...
	// Client script
	function btnLoading(a){$("#"+a).prop("disabled",!0),$("#"+a).empty(),$("#"+a).html('<i class="fa fa-spinner fa-spin"></i>')}function btnLoadingGone(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Draft")}function btnLoadingGoneCetak(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Cetak Nota")}function random_interval(){return Math.floor(1e3*Math.random()*8)}function drawDetailRMD(a){$("#detail-rmd").empty(),""!=a&&($("#detail-rmd").append('\n\t\t\t<style>\n\t\t\t.loader {\n  \t\t\t\tborder: 5px solid #f3f3f3;\n  \t\t\t\t-webkit-animation: spin 1s linear infinite;\n\t\t\t\tanimation: spin 1s linear infinite;\n\t\t\t\tborder-top: 5px solid #555;\n\t\t\t\tborder-radius: 50%;\n\t\t\t\twidth: 50px;\n\t\t\t\theight: 50px;\n  \t\t\t}\n\n\t\t\t/* Safari */\n\t\t\t@-webkit-keyframes spin {\n  \t\t\t\t0% { -webkit-transform: rotate(0deg); }\n  \t\t\t\t100% { -webkit-transform: rotate(360deg); }\n  \t\t\t}\n\n\t\t\t@keyframes spin {\n  \t\t\t\t0% { transform: rotate(0deg); }\n  \t\t\t\t100% { transform: rotate(360deg); }\n  \t\t\t}\n\t\t\t</style>\n\t\t\t<div id="loader" class="loader"></div>\n\t\t'),axios.get(`api/?action=list&object=view_rmd&id_rekmeddok=${a}&recperpage=ALL`).then(function({data:t}){console.log(t),$("#detail-rmd").empty(),$("#detail-rmd").append('\n\t\t\t\t<div class="row"  style="margin-top: 2em; margin-bottom: 1em;">\n\t\t\t\t\t<label for="table-rmd" style="margin-right: auto;">Detail Rekam Medis</label>\n\t\t\t\t\t<div id="tutup-detail-rmd" class="btn btn-outline-dark btn-sm" onclick="$(\'#detail-rmd\').empty();">close x</div>\n\t\t\t\t</div>\n\t\t\t\t<table id="table-rmd" class="table table-hover table-striped" style="margin-bottom: 2em;">\n\t\t\t\t\t<thead style="background-color: #B7D8DC;">\n\t\t\t\t\t\t<tr style="text-transform: uppercase; font-weight: 500; font-size: 12px;">\n\t\t\t\t\t\t\t<th style="padding: 10px;">Barang</th>\n\t\t\t\t\t\t\t<th style="padding: 10px;">Jumlah</th>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody id="detail-barang-rmd"></tbody>\n\t\t\t\t</table>\n\t\t\t'),t.view_rmd.forEach(function(t){if(t.id_rekmeddok==a){var i=t.nama_barang,n=t.jumlah;$("#detail-barang-rmd").append(`\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${i}</td>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${n}</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t`)}})}).catch(function(a){console.log(a)}))}$(".card.ew-card.ew-grid.ew-grid-add-edit.detailpenjualan").appendTo("#daftar-barang"),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("th[data-name=id_barang]").css({display:"none"}),$("td[data-name=id_barang]").css({display:"none"}),$("#btn-action").html("Draft"),$("div[id=status_penjualan]").css({display:"none"}),$("#btn-action").click(function(){setTimeout(function(){},random_interval()),console.log(random_interval()),$("#btn-action").attr("disabled",!0),$("#btn-action-cetak").attr("disabled",!0),$("#btn-action").attr("disabled",!1),$("#btn-action-cetak").attr("disabled",!1),$('input[name="x_status"][value="Printed"]').prop("checked",null),$('input[name="x_status"][value="Draft"]').prop("checked",!0)}),$("#btn-action").after('&nbsp;<button class="btn btn-info ew-btn" name="btn-action-cetak" id="btn-action-cetak" type="submit" style="height: 50px !important; width: 20% !important;">Cetak Nota</button>'),$("#btn-action-cetak").click(function(){$('input[name="x_status"][value="Printed"]').prop("checked",!0),$('input[name="x_status"][value="Draft"]').prop("checked",null),console.log("Bisaa")}),$("#x_status").change(function(){this.checked&&"Printed"==this.value&&(console.log("Sebenernnya bisa tapi gatau kenapa"),$("#myModal").modal())}),$("#x_metode_pembayaran option").each(function(){var a=$("#x_metode_pembayaran :selected").text();"Tunai"==a?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai-Debit"==a||"Tunai-Kredit"==a?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==a?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}))}),$("[data-field=x_metode_pembayaran]").change(function(){$("[data-field=x_bayar]").val("0"),$("[data-field=x_charge]").val("0"),$("[data-field=x_id_kartubank]").val(""),$("[data-field=x_id_kas]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_ongkir]").val("0"),"Tunai"==$(this).val()?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai-Debit"==$(this).val()||"Tunai-Kredit"==$(this).val()?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==$(this).val()?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}));var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n)}),$("#x_id_pelanggan").change(function(){$("#x_diskon_persen").val("0"),$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(""),$("#x_id_member").val("");var a=$(this).val(),t=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${a}`),i=axios.get("api/?action=list&object=m_member&recperpage=ALL"),n=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL");axios.all([t,i,n]).then(axios.spread(function(...a){console.log(a[0].data),console.log(a[1].data),console.log(a[2].data),a[0].data.m_pelanggan.forEach(function(t,i){var n=a[1].data.m_member.find(function({id_pelanggan:a}){return a==t.id_pelanggan}),l=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==n.jenis_member}),e=l.disc_prosen;console.log(e),console.log(n.disc_nominal),console.log(l.nama_member),console.log(l.id_jenis_member),null!=e?$("#x_diskon_persen").val(e):$("#x_diskon_persen").val("0"),null!=l.disc_nominal?$("#x_diskon_rupiah").val(l.disc_nominal):$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(l.nama_member),$("#x_id_member").val(n.jenis_member),$("#sv_x_id_member").prop("disabled",!0)})}))}),$("#x_klaim_poin").keyup(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n);var b=$(this).val(),g=$("[data-field=x_total]").val(),u=$("#x_id_pelanggan").val(),k=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${u}`),f=axios.get("api/?action=list&object=m_member&recperpage=ALL"),m=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL"),x=axios.get("api/?action=list&object=m_poin&recperpage=ALL");axios.all([k,f,m,x]).then(axios.spread(function(...a){console.log(a[0].data),console.log(a[1].data),console.log(a[2].data),console.log(a[3].data),a[0].data.m_pelanggan.forEach(function(t,i){var n=a[1].data.m_member.find(function({id_pelanggan:a}){return a==t.id_pelanggan}),l=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==n.jenis_member}),e=a[3].data.m_poin.find(function({id_jenis_member:a}){return a==l.id_jenis_member});console.log(e.curs_to_rp),console.log(e.max_klaim),b>e.max_klaim&&alert("Klaim Poin Tidak Boleh melebihi maksimal klaim");var o=b*e.curs_to_rp;$("#x_total_penukaran_poin").val(o);var d=$("#x_total_penukaran_poin").val();$("[data-field=x_total]").val(g-d)})}))}),$("[data-field=x_harga_jual], [data-field=x_kode_barang]").change(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n);var b=$("[data-field=x_metode_pembayaran]").val();"Tunai"==b?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==b||"Tunai-Debit"==b?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=b&&"Debit"!=b&&"Kredit"!=b||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("[data-field=x_harga_jual], [data-field=x_qty], [data-field=x_diskon_persen], [data-field=x_diskon_rupiah], [data-field=x_ppn], [data-field=x_disc_pr], [data-field=x_disc_rp], [data-field=x_ongkir]").keyup(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n),"Tunai"==metode?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==metode||"Tunai-Debit"==metode?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=metode&&"Debit"!=metode&&"Kredit"!=metode||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("#x_bayar").keyup(function(){$("[data-field=x_total_non_tunai_charge]").val("0");var a=parseInt($("[data-field=x_total]").val().split(".").join("")),t=parseInt($("[data-field=x_bayar]").val()),i=parseInt($("[data-field=x_total_non_tunai_charge]").val()),n=parseInt(t+i)-a;console.log("Non Tunai: "+i),$("#kembalian").val(n),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}),$("#x_id_rmd").keydown(function(){drawDetailRMD($("#x_id_rmd").val())}),$("#x_id_pelanggan").change(function(){$("#x_id_rmd").val(""),$("#sv_x_id_rmd").val("");var a=$(this).val();axios.get(`api/?action=list&object=rekmeddokter&id_pelanggan=${a}`).then(function(a){console.log(a.data);var t=a.data.rekmeddokter;t.sort();var i=t[0].id_rekmeddok,n=t[0].kode_rekmeddok;$("#sv_x_id_rmd").val(n),$("#x_id_rmd").val(i),drawDetailRMD(i)}).catch(function(a){console.log(a)})}),$("#x_id_kartubank").change(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n),$("[data-field=x_charge]").val("");$("[data-field=x_total]").val().split(".").join("");var b=$("#x_id_kartubank").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){console.log(a.data);var t=a.data.m_kartu,i=t.charge_price;if("Persentase"==t.charge_type){var n=i.replace(".",",");null!=n?$("[data-field=x_charge]").val(n):$("[data-field=x_charge]").val("0")}else null!=i?$("[data-field=x_charge]").val(i):$("[data-field=x_charge]").val("0")}).catch(function(a){console.log(a)})}),$("#x_bayar_non_tunai").keyup(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+parseInt(o),console.log("Total: "+n),$("[data-field=x_total]").val(n);var b=$("[data-field=x_total]").val().split(".").join(""),g=$("#x_id_kartubank").val(),u=$(this).val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${g}`).then(function(a){console.log(a.data);var t=a.data.m_kartu,i=t.charge_price;if("Persentase"==t.charge_type){i.replace(".",",");var n=parseInt(b)+parseInt(i/100*u),l=parseInt(u)+parseInt(i/100*u);console.log(n),$("[data-field=x_total]").val(n),$("[data-field=x_total_non_tunai_charge]").val(l);var e=parseInt($("[data-field=x_bayar]").val()),o=(d=parseInt(e+l))-n;console.log("Tunai: "+e),console.log("Non Tunai: "+l),console.log("Bayar Total: "+d),console.log("Kembalian: "+o),$("#kembalian").val(o),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{n=parseInt(b)+parseInt(i),l=parseInt(u)+parseInt(i);console.log(n),$("[data-field=x_total]").val(n),$("[data-field=x_total_non_tunai_charge]").val(l);var d;e=parseInt($("[data-field=x_bayar]").val()),o=(d=parseInt(e+l))-n;console.log("Tunai: "+e),console.log("Non Tunai: "+l),console.log("Bayar Total: "+d),console.log("Kembalian: "+o),$("#kembalian").val(o),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){$("[data-field=x_total_non_tunai_charge]").val(u);var t=parseInt($("[data-field=x_bayar]").val()),i=parseInt($("[data-field=x_bayar_non_tunai]").val()),n=parseInt(t+i)-b;$("#kembalian").val(n),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak")),console.log(a)})}),$("#x_id_kartu").change(function(){var a=$(this).attr("id");console.log(a);var t="#"+a.split("_")[0];console.log(t);var i,n,l,e,o,d=t+"_harga_jual",s=t+"_qty",r=t+"_disc_pr",_=t+"_disc_rp",c=t+"_subtotal",p=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,i=d*$(s).val(),$(c).val(i-i*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),charge=$("[data-field=x_charge]").val(),v=$("[data-field=x_diskon_persen]").val(),l=$("[data-field=x_diskon_rupiah]").val(),e=$("[data-field=x_ppn]").val(),o=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,charge?charge=charge.split(",").join("."):charge=0,console.log("Sub Total: "+p),console.log("Diskon Global(%): "+v+"% ("+p*v/100+")"),console.log("Diskon Global(Rp): "+l),console.log("PPN: "+e+"% ("+p*e/100+")"),n=p-l-p*v/100+p*e/100+p*charge/100+o,console.log("Total: "+n),$("[data-field=x_total]").val(n);var b=$("[data-field=x_total]").val(),g=$("#x_id_kartu").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${g}`).then(function(a){console.log(a.data);var t=a.data.m_kartu.charge_price,i=parseInt(b)-parseInt(t);console.log(i),$("[data-field=x_total]").val(i)}).catch(function(a){console.log(a)})});
});
</script>
...
<?php } ?>
<?php if ($penjualan_edit->status_void->Visible) { // status_void ?>
	<div id="r_status_void" class="form-group row">
		<label id="elh_penjualan_status_void" for="x_status_void" class="<?php echo $penjualan_edit->LeftColumnClass ?>"><script id="tpc_penjualan_status_void" type="text/html"><?php echo $penjualan_edit->status_void->caption() ?><?php echo $penjualan_edit->status_void->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></script></label>
		<div class="<?php echo $penjualan_edit->RightColumnClass ?>"><div <?php echo $penjualan_edit->status_void->cellAttributes() ?>>
<script id="tpx_penjualan_status_void" type="text/html"><span id="el_penjualan_status_void">
<input type="text" data-table="penjualan" data-field="x_status_void" name="x_status_void" id="x_status_void" size="30" maxlength="50" placeholder="<?php echo HtmlEncode($penjualan_edit->status_void->getPlaceHolder()) ?>" value="<?php echo $penjualan_edit->status_void->EditValue ?>"<?php echo $penjualan_edit->status_void->editAttributes() ?>>
</span></script>
<?php echo $penjualan_edit->status_void->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
