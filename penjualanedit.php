...
loadjs.ready("head", function() {
	...
	// Client script
	function btnLoading(a){$("#"+a).prop("disabled",!0),$("#"+a).empty(),$("#"+a).html('<i class="fa fa-spinner fa-spin"></i>')}function btnLoadingGone(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Draft")}function btnLoadingGoneCetak(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Cetak Nota")}function drawDetailRMD(a){$("#detail-rmd").empty(),""!=a&&($("#detail-rmd").append('\n\t\t\t<style>\n\t\t\t.loader {\n  \t\t\t\tborder: 5px solid #f3f3f3;\n  \t\t\t\t-webkit-animation: spin 1s linear infinite;\n\t\t\t\tanimation: spin 1s linear infinite;\n\t\t\t\tborder-top: 5px solid #555;\n\t\t\t\tborder-radius: 50%;\n\t\t\t\twidth: 50px;\n\t\t\t\theight: 50px;\n  \t\t\t}\n\n\t\t\t/* Safari */\n\t\t\t@-webkit-keyframes spin {\n  \t\t\t\t0% { -webkit-transform: rotate(0deg); }\n  \t\t\t\t100% { -webkit-transform: rotate(360deg); }\n  \t\t\t}\n\n\t\t\t@keyframes spin {\n  \t\t\t\t0% { transform: rotate(0deg); }\n  \t\t\t\t100% { transform: rotate(360deg); }\n  \t\t\t}\n\t\t\t</style>\n\t\t\t<div id="loader" class="loader"></div>\n\t\t'),axios.get(`api/?action=list&object=view_rmd&id_rekmeddok=${a}&recperpage=ALL`).then(function({data:t}){console.log(t),$("#detail-rmd").empty(),$("#detail-rmd").append('\n\t\t\t\t<div class="row"  style="margin-top: 2em; margin-bottom: 1em;">\n\t\t\t\t\t<label for="table-rmd" style="margin-right: auto;">Detail Rekam Medis</label>\n\t\t\t\t\t<div id="tutup-detail-rmd" class="btn btn-outline-dark btn-sm" onclick="$(\'#detail-rmd\').empty();">close x</div>\n\t\t\t\t</div>\n\t\t\t\t<table id="table-rmd" class="table table-hover table-striped" style="margin-bottom: 2em;">\n\t\t\t\t\t<thead style="background-color: #B7D8DC;">\n\t\t\t\t\t\t<tr style="text-transform: uppercase; font-weight: 500; font-size: 12px;">\n\t\t\t\t\t\t\t<th style="padding: 10px;">Barang</th>\n\t\t\t\t\t\t\t<th style="padding: 10px;">Jumlah</th>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody id="detail-barang-rmd"></tbody>\n\t\t\t\t</table>\n\t\t\t'),t.view_rmd.forEach(function(t){if(t.id_rekmeddok==a){var n=t.nama_barang,i=t.jumlah;$("#detail-barang-rmd").append(`\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${n}</td>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${i}</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t`)}})}).catch(function(a){console.log(a)}))}$(".card.ew-card.ew-grid.ew-grid-add-edit.detailpenjualan").appendTo("#daftar-barang"),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("th[data-name=id_barang]").css({display:"none"}),$("td[data-name=id_barang]").css({display:"none"}),$("#btn-action").html("Draft"),$("div[id=status_penjualan]").css({display:"none"}),$(".ew-grid-delete").click(function(){$(".btn-primary.ew-btn").click(function(){var a=$("[data-field=x_harga_jual]").attr("id");if("x$rowindex$_harga_jual"==a)var t="#"+a.split("_")[1];else t="#"+a.split("_")[0];var n,i,e,l,d,o=t+"_harga_jual",r=t+"_qty",_=t+"_disc_pr",s=t+"_disc_rp",c=t+"_subtotal",v=parseInt(0),p=0;o=$(o).val()?$(o).val().split(".").join(""):0,_=$(_).val()?$(_).val().split(",").join("."):0,n=o*$(r).val(),$(c).val(n-n*_/100-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),e=$("[data-field=x_diskon_rupiah]").val(),l=$("[data-field=x_ppn]").val(),d=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,i=v-e-v*p/100+v*l/100+parseInt(d);var b=$("#x_id_kartu").val(),f=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){console.log(a.data);var t=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(i)-parseInt(t)*f-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(i)-parseInt(t)*f;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var k=$("[data-field=x_total_penukaran_poin]").val();if(""!=k){var u=parseInt(i)-parseInt(k);$("[data-field=x_total]").val(u)}else $("[data-field=x_total]").val(i)}})}),$("#x_metode_pembayaran option").each(function(){var a=$("#x_metode_pembayaran :selected").text();"Tunai"==a?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai-Debit"==a||"Tunai-Kredit"==a?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==a?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}))}),$("[data-field=x_metode_pembayaran]").change(function(){$("[data-field=x_bayar]").val("0"),$("[data-field=x_charge]").val("0"),$("[data-field=x_id_kartubank]").val(""),$("[data-field=x_id_kas]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_ongkir]").val("0"),"Tunai"==$(this).val()?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai-Debit"==$(this).val()||"Tunai-Kredit"==$(this).val()?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==$(this).val()?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}));var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("#x_id_kartu").val(),b=$("#x_jumlah_voucher").val();if(""!=p)axios.get(`api/?action=view&object=m_kartu&id_kartu=${p}`).then(function(a){var n=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(t)-parseInt(n)*b-parseInt(i);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(n)*b;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}}),$("#x_id_pelanggan").change(function(){$("#x_diskon_persen").val("0"),$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(""),$("#x_id_member").val("");var a=$(this).val(),t=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${a}`),n=axios.get("api/?action=list&object=m_member&recperpage=ALL"),i=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL");axios.all([t,n,i]).then(axios.spread(function(...a){console.log(a[0].data),console.log(a[1].data),console.log(a[2].data),a[0].data.m_pelanggan.forEach(function(t,n){var i=a[1].data.m_member.find(function({id_pelanggan:a}){return a==t.id_pelanggan}),e=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==i.jenis_member}),l=e.disc_prosen;console.log(l),console.log(i.disc_nominal),console.log(e.nama_member),console.log(e.id_jenis_member),null!=l?$("#x_diskon_persen").val(l):$("#x_diskon_persen").val("0"),null!=e.disc_nominal?$("#x_diskon_rupiah").val(e.disc_nominal):$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(e.nama_member),$("#x_id_member").val(i.jenis_member),$("#sv_x_id_member").prop("disabled",!0)})}))}),$("#x_klaim_poin").keyup(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;if(d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,t=c-n-c*v/100+c*i/100+parseInt(e),""!=(p=$("#x_id_kartu").val())){var p=$("#x_id_kartu").val(),b=$("#x_jumlah_voucher").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${p}`).then(function(a){var n=a.data.m_kartu.charge_price,i=parseInt(t)-parseInt(n)*b;$("[data-field=x_total]").val(i)}).catch(function(a){console.log(a)})}else $("[data-field=x_total]").val(t);var f=$(this).val(),k=$("#x_id_pelanggan").val(),u=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${k}`),g=axios.get("api/?action=list&object=m_member&recperpage=ALL"),x=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL"),h=axios.get("api/?action=list&object=m_poin&recperpage=ALL");axios.all([u,g,x,h]).then(axios.spread(function(...a){a[0].data.m_pelanggan.forEach(function(n,i){var e=a[1].data.m_member.find(function({id_pelanggan:a}){return a==n.id_pelanggan}),l=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==e.jenis_member}),d=a[3].data.m_poin.find(function({id_jenis_member:a}){return a==l.id_jenis_member});d.max_klaim;var o=f*d.curs_to_rp;$("#x_total_penukaran_poin").val(o);var r=$("#x_id_kartu").val(),_=$("#x_total_penukaran_poin").val();if(""!=r){r=$("#x_id_kartu").val();var s=$("#x_jumlah_voucher").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${r}`).then(function(a){var n=a.data.m_kartu.charge_price,i=parseInt(t)-parseInt(n)*s;$("[data-field=x_total]").val(i-_)}).catch(function(a){console.log(a)})}else{_=$("#x_total_penukaran_poin").val();$("[data-field=x_total]").val(t-_)}})}))}),$("[data-field=x_harga_jual], [data-field=x_kode_barang]").change(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("#x_id_kartu").val(),b=$("#x_jumlah_voucher").val();if(""!=p)axios.get(`api/?action=view&object=m_kartu&id_kartu=${p}`).then(function(a){var n=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(t)-parseInt(n)*b-parseInt(i);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(n)*b;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}$("[data-field=x_total]").val(t);var u=$("[data-field=x_metode_pembayaran]").val();"Tunai"==u?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==u||"Tunai-Debit"==u?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=u&&"Debit"!=u&&"Kredit"!=u||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("[data-field=x_harga_jual], [data-field=x_qty], [data-field=x_diskon_persen], [data-field=x_diskon_rupiah], [data-field=x_ppn], [data-field=x_disc_pr], [data-field=x_disc_rp], [data-field=x_ongkir]").keyup(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("#x_id_kartu").val(),b=$("#x_jumlah_voucher").val();if(""!=p)axios.get(`api/?action=view&object=m_kartu&id_kartu=${p}`).then(function(a){var n=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(t)-parseInt(n)*b-parseInt(i);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(n)*b;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}var u=$("[data-field=x_metode_pembayaran]").val();"Tunai"==u?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==u||"Tunai-Debit"==u?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=u&&"Debit"!=u&&"Kredit"!=u||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("#x_bayar").keyup(function(){$("[data-field=x_total_non_tunai_charge]").val("0");var a=parseInt($("[data-field=x_total]").val().split(".").join("")),t=parseInt($("[data-field=x_bayar]").val()),n=parseInt($("[data-field=x_total_non_tunai_charge]").val()),i=parseInt(t+n)-a;console.log("Non Tunai: "+n),$("#kembalian").val(i),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}),$("#x_id_rmd").keydown(function(){drawDetailRMD($("#x_id_rmd").val())}),$("#x_id_pelanggan").change(function(){$("#x_id_rmd").val(""),$("#sv_x_id_rmd").val("");var a=$(this).val();axios.get(`api/?action=list&object=rekmeddokter&id_pelanggan=${a}`).then(function(a){console.log(a.data);var t=a.data.rekmeddokter;t.sort();var n=t[0].id_rekmeddok,i=t[0].kode_rekmeddok;$("#sv_x_id_rmd").val(i),$("#x_id_rmd").val(n),drawDetailRMD(n)}).catch(function(a){console.log(a)})}),$("#x_id_kartubank").change(function(){if(""!=$("#x_bayar_non_tunai").val()){var a=(g="#"+$(this).attr("id").split("_")[0])+"_harga_jual",t=g+"_qty",n=g+"_disc_pr",i=g+"_disc_rp",e=g+"_subtotal",l=parseInt(0),d=0,o=0,r=0,_=0,s=0,c=0;a=$(a).val()?$(a).val().split(".").join(""):0,n=$(n).val()?$(n).val().split(",").join("."):0,d=a*$(t).val(),$(e).val(d-d*n/100-$(i).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(l+=parseInt($(this).val()))}),r=$("[data-field=x_diskon_persen]").val(),_=$("[data-field=x_diskon_rupiah]").val(),s=$("[data-field=x_ppn]").val(),c=$("[data-field=x_ongkir]").val(),r=r?r.split(",").join("."):0,o=l-_-l*r/100+l*s/100+parseInt(c);var v=$("#x_id_kartu").val(),p=$("#x_jumlah_voucher").val();if(""!=v)axios.get(`api/?action=view&object=m_kartu&id_kartu=${v}`).then(function(a){var t=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var i=parseInt(o)-parseInt(t)*p-parseInt(n);$("[data-field=x_total]").val(i)}else{i=parseInt(o)-parseInt(t)*p;$("[data-field=x_total]").val(i)}}).catch(function(a){console.log(a)});else if(""!=(x=$("[data-field=x_total_penukaran_poin]").val())){var b=parseInt(o)-parseInt(x);$("[data-field=x_total]").val(b)}else $("[data-field=x_total]").val(o);var f=$("[data-field=x_total]").val().split(".").join(""),k=$("#x_id_kartubank").val(),u=$("[data-field=x_bayar_non_tunai]").val();console.log(f),axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu,n=t.charge_price,i=t.charge_type;if(console.log(n),"Persentase"==i){var e=$("#x_id_kartu").val(),l=$("#x_jumlah_voucher").val();if(""!=e)axios.get(`api/?action=view&object=m_kartu&id_kartu=${e}`).then(function(a){var t=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(o)-parseInt(t)*l-parseInt(i),d=n.replace(".",","),r=parseInt(e)+parseInt(n/100*u),_=parseInt(u)+parseInt(n/100*u);console.log(r),console.log(_),$("[data-field=x_charge]").val(d),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);var s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{e=parseInt(o)-parseInt(t)*l,d=n.replace(".",","),r=parseInt(e)+parseInt(n/100*u),_=parseInt(u)+parseInt(n/100*u);console.log(r),console.log(_),$("[data-field=x_charge]").val(d),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(p=$("[data-field=x_total_penukaran_poin]").val())){var d=parseInt(o)-parseInt(p),r=n.replace(".",","),_=parseInt(d)+parseInt(n/100*u),s=parseInt(u)+parseInt(n/100*u);console.log(_),console.log(s),$("[data-field=x_charge]").val(r),$("[data-field=x_total]").val(_),$("[data-field=x_total_non_tunai_charge]").val(s);var c=parseInt($("[data-field=x_bayar]").val()),v=parseInt(c+s)-_;$("#kembalian").val(v),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{r=n.replace(".",","),_=parseInt(o)+parseInt(n/100*u),s=parseInt(u)+parseInt(n/100*u);console.log(_),console.log(s),$("[data-field=x_charge]").val(r),$("[data-field=x_total]").val(_),$("[data-field=x_total_non_tunai_charge]").val(s);c=parseInt($("[data-field=x_bayar]").val()),v=parseInt(c+s)-_;$("#kembalian").val(v),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}else{var p;e=$("#x_id_kartu").val(),l=$("#x_jumlah_voucher").val();if(""!=e)axios.get(`api/?action=view&object=m_kartu&id_kartu=${e}`).then(function(a){var t=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(o)-parseInt(t)*l-parseInt(i),d=parseInt(e)+parseInt(n),r=parseInt(u)+parseInt(n);console.log(d),console.log(r),$("[data-field=x_charge]").val(n),$("[data-field=x_total]").val(d),$("[data-field=x_total_non_tunai_charge]").val(r);var _=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-d;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{e=parseInt(o)-parseInt(t)*l,d=parseInt(e)+parseInt(n),r=parseInt(u)+parseInt(n);console.log(d),console.log(r),$("[data-field=x_charge]").val(n),$("[data-field=x_total]").val(d),$("[data-field=x_total_non_tunai_charge]").val(r);_=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-d;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(p=$("[data-field=x_total_penukaran_poin]").val())){d=parseInt(o)-parseInt(p),_=parseInt(d)+parseInt(n),s=parseInt(u)+parseInt(n);console.log(_),console.log(s),$("[data-field=x_charge]").val(n),$("[data-field=x_total]").val(_),$("[data-field=x_total_non_tunai_charge]").val(s);c=parseInt($("[data-field=x_bayar]").val()),v=parseInt(c+s)-_;$("#kembalian").val(v),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{_=parseInt(o)+parseInt(n),s=parseInt(u)+parseInt(n);console.log(_),console.log(s),$("[data-field=x_charge]").val(n),$("[data-field=x_total]").val(_),$("[data-field=x_total_non_tunai_charge]").val(s);c=parseInt($("[data-field=x_bayar]").val()),v=parseInt(c+s)-_;$("#kembalian").val(v),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}}).catch(function(a){$("[data-field=x_total_non_tunai_charge]").val(u);var t=parseInt($("[data-field=x_bayar]").val()),n=parseInt($("[data-field=x_bayar_non_tunai]").val()),i=parseInt(t+n)-f;$("#kembalian").val(i),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak")),console.log(a)})}else{var g;a=(g="#"+$(this).attr("id").split("_")[0])+"_harga_jual",t=g+"_qty",n=g+"_disc_pr",i=g+"_disc_rp",e=g+"_subtotal",l=parseInt(0),d=0,o=0,r=0,_=0,s=0,c=0;a=$(a).val()?$(a).val().split(".").join(""):0,n=$(n).val()?$(n).val().split(",").join("."):0,d=a*$(t).val(),$(e).val(d-d*n/100-$(i).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(l+=parseInt($(this).val()))}),r=$("[data-field=x_diskon_persen]").val(),_=$("[data-field=x_diskon_rupiah]").val(),s=$("[data-field=x_ppn]").val(),c=$("[data-field=x_ongkir]").val(),r=r?r.split(",").join("."):0,o=l-_-l*r/100+l*s/100+parseInt(c);var x;v=$("#x_id_kartu").val(),p=$("#x_jumlah_voucher").val();if(""!=v)axios.get(`api/?action=view&object=m_kartu&id_kartu=${v}`).then(function(a){var t=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var i=parseInt(o)-parseInt(t)*p-parseInt(n);$("[data-field=x_total]").val(i)}else{i=parseInt(o)-parseInt(t)*p;$("[data-field=x_total]").val(i)}}).catch(function(a){console.log(a)});else if(""!=(x=$("[data-field=x_total_penukaran_poin]").val())){b=parseInt(o)-parseInt(x);$("[data-field=x_total]").val(b)}else $("[data-field=x_total]").val(o);$("[data-field=x_charge]").val("");f=$("[data-field=x_total]").val().split(".").join(""),k=$("#x_id_kartubank").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu,n=t.charge_price;if("Persentase"==t.charge_type){var i=n.replace(".",",");null!=i?$("[data-field=x_charge]").val(i):$("[data-field=x_charge]").val("0")}else null!=n?$("[data-field=x_charge]").val(n):$("[data-field=x_charge]").val("0")}).catch(function(a){console.log(a)})}}),$("#x_bayar_non_tunai").keyup(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("#x_id_kartu").val(),b=$("#x_jumlah_voucher").val();if(""!=p)axios.get(`api/?action=view&object=m_kartu&id_kartu=${p}`).then(function(a){var n=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(t)-parseInt(n)*b-parseInt(i);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(n)*b;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}var u=$("[data-field=x_total]").val().split(".").join(""),g=$("#x_id_kartubank").val(),x=$(this).val();console.log(u),axios.get(`api/?action=view&object=m_kartu&id_kartu=${g}`).then(function(a){var n=a.data.m_kartu,i=n.charge_price,e=n.charge_type;if(console.log(i),"Persentase"==e){var l=$("#x_id_kartu").val(),d=$("#x_jumlah_voucher").val();if(""!=l)axios.get(`api/?action=view&object=m_kartu&id_kartu=${l}`).then(function(a){var n=a.data.m_kartu.charge_price,e=$("[data-field=x_total_penukaran_poin]").val();if(""!=e){var l=parseInt(t)-parseInt(n)*d-parseInt(e),o=(i.replace(".",","),parseInt(l)+parseInt(i/100*x)),r=parseInt(x)+parseInt(i/100*x);console.log(o),console.log(r),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(r);var _=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-o;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{l=parseInt(t)-parseInt(n)*d,i.replace(".",","),o=parseInt(l)+parseInt(i/100*x),r=parseInt(x)+parseInt(i/100*x);console.log(o),console.log(r),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(r);_=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-o;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(v=$("[data-field=x_total_penukaran_poin]").val())){var o=parseInt(t)-parseInt(v),r=(i.replace(".",","),parseInt(o)+parseInt(i/100*x)),_=parseInt(x)+parseInt(i/100*x);console.log(r),console.log(_),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);var s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{i.replace(".",","),r=parseInt(t)+parseInt(i/100*x),_=parseInt(x)+parseInt(i/100*x);console.log(r),console.log(_),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}else{var v;l=$("#x_id_kartu").val(),d=$("#x_jumlah_voucher").val();if(""!=l)axios.get(`api/?action=view&object=m_kartu&id_kartu=${l}`).then(function(a){var n=a.data.m_kartu.charge_price,e=$("[data-field=x_total_penukaran_poin]").val();if(""!=e){var l=parseInt(t)-parseInt(n)*d-parseInt(e),o=parseInt(l)+parseInt(i),r=parseInt(x)+parseInt(i);console.log(o),console.log(r),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(r);var _=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-o;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{l=parseInt(t)-parseInt(n)*d,o=parseInt(l)+parseInt(i),r=parseInt(x)+parseInt(i);console.log(o),console.log(r),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(r);_=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+r)-o;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(v=$("[data-field=x_total_penukaran_poin]").val())){o=parseInt(t)-parseInt(v),r=parseInt(o)+parseInt(i),_=parseInt(x)+parseInt(i);console.log(r),console.log(_),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{r=parseInt(t)+parseInt(i),_=parseInt(x)+parseInt(i);console.log(r),console.log(_),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-r;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}}).catch(function(a){$("[data-field=x_total_non_tunai_charge]").val(x);var t=parseInt($("[data-field=x_bayar]").val()),n=parseInt($("[data-field=x_bayar_non_tunai]").val()),i=parseInt(t+n)-u;$("#kembalian").val(i),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak")),console.log(a)})}),$("#x_id_kartu").change(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),charge=$("[data-field=x_charge]").val(),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,charge?charge=charge.split(",").join("."):charge=0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("[data-field=x_total_penukaran_poin]").val();if(""!=p){var b=parseInt(t)-p;$("[data-field=x_total]").val(b)}else $("[data-field=x_total]").val(t);var f=$("[data-field=x_total]").val(),k=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var i=parseInt(f)-parseInt(t)*u-n;$("[data-field=x_total]").val(i)}else{i=parseInt(f)-parseInt(t)*u;$("[data-field=x_total]").val(i)}}).catch(function(a){console.log(a)})}),$("#x_jumlah_voucher").keyup(function(){var a,t,n,i,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",o=l+"_qty",r=l+"_disc_pr",_=l+"_disc_rp",s=l+"_subtotal",c=parseInt(0),v=0;d=$(d).val()?$(d).val().split(".").join(""):0,r=$(r).val()?$(r).val().split(",").join("."):0,a=d*$(o).val(),$(s).val(a-a*r/100-$(_).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(c+=parseInt($(this).val()))}),charge=$("[data-field=x_charge]").val(),v=$("[data-field=x_diskon_persen]").val(),n=$("[data-field=x_diskon_rupiah]").val(),i=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),v=v?v.split(",").join("."):0,charge?charge=charge.split(",").join("."):charge=0,t=c-n-c*v/100+c*i/100+parseInt(e);var p=$("[data-field=x_total_penukaran_poin]").val();if(""!=p){var b=parseInt(t)-p;$("[data-field=x_total]").val(b)}else $("[data-field=x_total]").val(t);var f=$("[data-field=x_total]").val(),k=$("#x_id_kartu").val(),u=$(this).val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var i=parseInt(f)-parseInt(t)*u-n;$("[data-field=x_total]").val(i)}else{i=parseInt(f)-parseInt(t)*u;$("[data-field=x_total]").val(i)}}).catch(function(a){console.log(a)})});
});
</script>
