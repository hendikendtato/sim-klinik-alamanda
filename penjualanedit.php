...
loadjs.ready("head", function() {
	...
	// Client script
	function btnLoading(a){$("#"+a).prop("disabled",!0),$("#"+a).empty(),$("#"+a).html('<i class="fa fa-spinner fa-spin"></i>')}function btnLoadingGone(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Draft")}function btnLoadingGoneCetak(a){$("#"+a).prop("disabled",!1),$("#"+a).html("Cetak Nota")}function drawDetailRMD(a){$("#detail-rmd").empty(),""!=a&&($("#detail-rmd").append('\n\t\t\t<style>\n\t\t\t.loader {\n  \t\t\t\tborder: 5px solid #f3f3f3;\n  \t\t\t\t-webkit-animation: spin 1s linear infinite;\n\t\t\t\tanimation: spin 1s linear infinite;\n\t\t\t\tborder-top: 5px solid #555;\n\t\t\t\tborder-radius: 50%;\n\t\t\t\twidth: 50px;\n\t\t\t\theight: 50px;\n  \t\t\t}\n\n\t\t\t/* Safari */\n\t\t\t@-webkit-keyframes spin {\n  \t\t\t\t0% { -webkit-transform: rotate(0deg); }\n  \t\t\t\t100% { -webkit-transform: rotate(360deg); }\n  \t\t\t}\n\n\t\t\t@keyframes spin {\n  \t\t\t\t0% { transform: rotate(0deg); }\n  \t\t\t\t100% { transform: rotate(360deg); }\n  \t\t\t}\n\t\t\t</style>\n\t\t\t<div id="loader" class="loader"></div>\n\t\t'),axios.get(`api/?action=list&object=view_rmd&id_rekmeddok=${a}&recperpage=ALL`).then(function({data:t}){console.log(t),$("#detail-rmd").empty(),$("#detail-rmd").append('\n\t\t\t\t<div class="row"  style="margin-top: 2em; margin-bottom: 1em;">\n\t\t\t\t\t<label for="table-rmd" style="margin-right: auto;">Detail Rekam Medis</label>\n\t\t\t\t\t<div id="tutup-detail-rmd" class="btn btn-outline-dark btn-sm" onclick="$(\'#detail-rmd\').empty();">close x</div>\n\t\t\t\t</div>\n\t\t\t\t<table id="table-rmd" class="table table-hover table-striped" style="margin-bottom: 2em;">\n\t\t\t\t\t<thead style="background-color: #B7D8DC;">\n\t\t\t\t\t\t<tr style="text-transform: uppercase; font-weight: 500; font-size: 12px;">\n\t\t\t\t\t\t\t<th style="padding: 10px;">Barang</th>\n\t\t\t\t\t\t\t<th style="padding: 10px;">Jumlah</th>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody id="detail-barang-rmd"></tbody>\n\t\t\t\t</table>\n\t\t\t'),t.view_rmd.forEach(function(t){if(t.id_rekmeddok==a){var i=t.nama_barang,n=t.jumlah;$("#detail-barang-rmd").append(`\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${i}</td>\n\t\t\t\t\t\t\t<td align="left" style="border: none; padding: 10px;">${n}</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t`)}})}).catch(function(a){console.log(a)}))}$(".card.ew-card.ew-grid.ew-grid-add-edit.detailpenjualan").appendTo("#daftar-barang"),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("h4.ew-detail-caption").hide(),$("th[data-name=id_barang]").css({display:"none"}),$("td[data-name=id_barang]").css({display:"none"}),$("#btn-action").html("Draft"),$("div[id=status_penjualan]").css({display:"none"}),$(".ew-grid-delete").click(function(){$(".btn-primary.ew-btn").click(function(){var a=$("[data-field=x_harga_jual]").attr("id");if("x$rowindex$_harga_jual"==a)var t="#"+a.split("_")[1];else t="#"+a.split("_")[0];var i,n,e,l,d,r=t+"_harga_jual",o=t+"_qty",_=t+"_disc_pr",s=t+"_disc_rp",c=t+"_voucher_barang",v=t+"_subtotal",p=parseInt(0),b=0;r=$(r).val()?$(r).val().split(".").join(""):0,_=$(_).val()?$(_).val().split(",").join("."):0,i=r*$(o).val(),$(v).val(i-i*_/100-$(s).val()-$(c).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(p+=parseInt($(this).val()))}),b=$("[data-field=x_diskon_persen]").val(),e=$("[data-field=x_diskon_rupiah]").val(),l=$("[data-field=x_ppn]").val(),d=$("[data-field=x_ongkir]").val(),b=b?b.split(",").join("."):0,n=p-e-p*b/100+p*l/100+parseInt(d);var u=$("#x_id_kartu").val(),f=$("#x_jumlah_voucher").val();if(""!=u)axios.get(`api/?action=view&object=m_kartu&id_kartu=${u}`).then(function(a){console.log(a.data);var t=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var e=parseInt(n)-parseInt(t)*f-parseInt(i);$("[data-field=x_total]").val(e)}else{e=parseInt(n)-parseInt(t)*f;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var k=$("[data-field=x_total_penukaran_poin]").val();if(""!=k){var g=parseInt(n)-parseInt(k);$("[data-field=x_total]").val(g)}else $("[data-field=x_total]").val(n)}})}),$("#x_metode_pembayaran option").each(function(){var a=$("#x_metode_pembayaran :selected").text();"Tunai"==a?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai - Kartu Debit"==a||"Tunai - Kartu Kredit"==a?($("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==a?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}))}),$("[data-field=x_metode_pembayaran]").change(function(){$("[data-field=x_bayar]").val("0"),$("[data-field=x_charge]").val("0"),$("[data-field=x_id_kartubank]").val(""),$("[data-field=x_id_kas]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_ongkir]").val("0"),"Tunai"==$(this).val()?($("div[id=r_id_bank]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_charge]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"none"}),$("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"none"})):"Tunai-Debit"==$(this).val()?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Tunai-Kredit"==$(this).val()?($("div[id=r_bayar]").css({display:"inline-block"}),$("div[id=r_id_kas]").css({display:"inline-block"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"})):"Transfer"==$(this).val()?($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_kartubank]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"})):($("div[id=r_bayar]").css({display:"none"}),$("div[id=r_id_kas]").css({display:"none"}),$("div[id=r_id_bank]").css({display:"inline-block"}),$("div[id=r_id_kartubank]").css({display:"inline-block"}),$("div[id=r_bayar_non_tunai]").css({display:"inline-block"}),$("div[id=r_total_non_tunai_charge]").css({display:"inline-block"}),$("div[id=r_charge]").css({display:"inline-block"}));var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(t)-parseInt(i)*u-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}}),$("#x_id_pelanggan").change(function(){$("#x_diskon_persen").val("0"),$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(""),$("#x_id_member").val("");var a=$(this).val(),t=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${a}`),i=axios.get("api/?action=list&object=m_member&recperpage=ALL"),n=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL");axios.all([t,i,n]).then(axios.spread(function(...a){console.log(a[0].data),console.log(a[1].data),console.log(a[2].data),a[0].data.m_pelanggan.forEach(function(t,i){var n=a[1].data.m_member.find(function({id_pelanggan:a}){return a==t.id_pelanggan}),e=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==n.jenis_member}),l=e.disc_prosen;console.log(l),console.log(n.disc_nominal),console.log(e.nama_member),console.log(e.id_jenis_member),null!=l?$("#x_diskon_persen").val(l):$("#x_diskon_persen").val("0"),null!=e.disc_nominal?$("#x_diskon_rupiah").val(e.disc_nominal):$("#x_diskon_rupiah").val("0"),$("#sv_x_id_member").val(e.nama_member),$("#x_id_member").val(n.jenis_member),$("#sv_x_id_member").prop("disabled",!0)})}))}),$("#x_klaim_poin").keyup(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b){b=$("#x_id_kartu").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(n)}).catch(function(a){console.log(a)})}else $("[data-field=x_total]").val(t);var f=$(this).val(),k=$("#x_id_pelanggan").val(),g=axios.get(`api/?action=list&object=m_pelanggan&id_pelanggan=${k}`),x=axios.get("api/?action=list&object=m_member&recperpage=ALL"),h=axios.get("api/?action=list&object=m_jenis_member&recperpage=ALL"),m=axios.get("api/?action=list&object=m_poin&recperpage=ALL");axios.all([g,x,h,m]).then(axios.spread(function(...a){a[0].data.m_pelanggan.forEach(function(i,n){var e=a[1].data.m_member.find(function({id_pelanggan:a}){return a==i.id_pelanggan}),l=a[2].data.m_jenis_member.find(function({id_jenis_member:a}){return a==e.jenis_member}),d=a[3].data.m_poin.find(function({id_jenis_member:a}){return a==l.id_jenis_member});d.max_klaim;var r=f*d.curs_to_rp;$("#x_total_penukaran_poin").val(r);var o=$("#x_id_kartu").val(),_=$("#x_total_penukaran_poin").val();if(""!=o){o=$("#x_id_kartu").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${o}`).then(function(a){var i=a.data.m_kartu.charge_price,n=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(n-_)}).catch(function(a){console.log(a)})}else{_=$("#x_total_penukaran_poin").val();$("[data-field=x_total]").val(t-_)}})}))}),$("[data-field=x_harga_jual], [data-field=x_kode_barang]").change(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(t)-parseInt(i)*u-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}$("[data-field=x_total]").val(t);var g=$("[data-field=x_metode_pembayaran]").val();"Tunai"==g?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==g||"Tunai-Debit"==g?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=g&&"Debit"!=g&&"Kredit"!=g||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("[data-field=x_harga_jual], [data-field=x_qty], [data-field=x_diskon_persen], [data-field=x_diskon_rupiah], [data-field=x_ppn], [data-field=x_disc_pr], [data-field=x_disc_rp], [data-field=x_ongkir], [data-field=x_voucher_barang]").keyup(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(t)-parseInt(i)*u-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}var g=$("[data-field=x_metode_pembayaran]").val();"Tunai"==g?$("[data-field=x_bayar]").val(""):"Tunai-Kredit"==g||"Tunai-Debit"==g?($("[data-field=x_bayar]").val(""),$("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0")):"Transfer"!=g&&"Debit"!=g&&"Kredit"!=g&&"E-Wallet"!=g||($("[data-field=x_bayar_non_tunai]").val(""),$("[data-field=x_total_non_tunai_charge]").val("0"))}),$("#x_bayar").keyup(function(){$("[data-field=x_total_non_tunai_charge]").val("0");var a=parseInt($("[data-field=x_total]").val().split(".").join("")),t=parseInt($("[data-field=x_bayar]").val()),i=parseInt($("[data-field=x_total_non_tunai_charge]").val()),n=parseInt(t+i)-a;console.log("Non Tunai: "+i),$("#kembalian").val(n),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}),$("#x_id_rmd").keydown(function(){drawDetailRMD($("#x_id_rmd").val())}),$("#x_id_pelanggan").change(function(){$("#x_id_rmd").val(""),$("#sv_x_id_rmd").val("");var a=$(this).val();axios.get(`api/?action=list&object=rekmeddokter&id_pelanggan=${a}`).then(function(a){console.log(a.data);var t=a.data.rekmeddokter;t.sort();var i=t[0].id_rekmeddok,n=t[0].kode_rekmeddok;$("#sv_x_id_rmd").val(n),$("#x_id_rmd").val(i),drawDetailRMD(i)}).catch(function(a){console.log(a)})}),$("#x_id_kartubank").change(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(t)-parseInt(i)*u-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}$("[data-field=x_charge]").val("");$("[data-field=x_total]").val().split(".").join("");var g=$("#x_id_kartubank").val(),x=$("[data-field=x_bayar_non_tunai]").val();console.log(x),axios.get(`api/?action=view&object=m_kartu&id_kartu=${g}`).then(function(a){var t=a.data.m_kartu,i=t.charge_price;if("Persentase"==t.charge_type){var n=i.replace(".",","),e=parseInt(x)+parseInt(i/100*x);null!=n?($("[data-field=x_charge]").val(n),""!=x&&($("[data-field=x_total_non_tunai_charge]").val(e),$("[data-field=x_total]").val(e))):$("[data-field=x_charge]").val("0")}else{e=parseInt(x)+parseInt(i);null!=i?($("[data-field=x_charge]").val(i),""!=x&&($("[data-field=x_total_non_tunai_charge]").val(e),$("[data-field=x_total]").val(e))):$("[data-field=x_charge]").val("0")}}).catch(function(a){console.log(a)})}),$("#x_bayar_non_tunai").keyup(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("#x_id_kartu").val(),u=$("#x_jumlah_voucher").val();if(""!=b)axios.get(`api/?action=view&object=m_kartu&id_kartu=${b}`).then(function(a){var i=a.data.m_kartu.charge_price,n=$("[data-field=x_total_penukaran_poin]").val();if(""!=n){var e=parseInt(t)-parseInt(i)*u-parseInt(n);$("[data-field=x_total]").val(e)}else{e=parseInt(t)-parseInt(i)*u;$("[data-field=x_total]").val(e)}}).catch(function(a){console.log(a)});else{var f=$("[data-field=x_total_penukaran_poin]").val();if(""!=f){var k=parseInt(t)-parseInt(f);$("[data-field=x_total]").val(k)}else $("[data-field=x_total]").val(t)}var g=$("[data-field=x_total]").val().split(".").join(""),x=$("#x_id_kartubank").val(),h=$(this).val();console.log(g),axios.get(`api/?action=view&object=m_kartu&id_kartu=${x}`).then(function(a){var i=a.data.m_kartu,n=i.charge_price,e=i.charge_type;if(console.log(n),"Persentase"==e){var l=$("#x_id_kartu").val(),d=$("#x_jumlah_voucher").val();if(""!=l)axios.get(`api/?action=view&object=m_kartu&id_kartu=${l}`).then(function(a){var i=a.data.m_kartu.charge_price,e=$("[data-field=x_total_penukaran_poin]").val();if(""!=e){var l=parseInt(t)-parseInt(i)*d-parseInt(e),r=(n.replace(".",","),parseInt(l)+parseInt(n/100*h)),o=parseInt(h)+parseInt(n/100*h);console.log(r),console.log(o),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(o);var _=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+o)-r;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{l=parseInt(t)-parseInt(i)*d,n.replace(".",","),r=parseInt(l)+parseInt(n/100*h),o=parseInt(h)+parseInt(n/100*h);console.log(r),console.log(o),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(o);_=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+o)-r;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(v=$("[data-field=x_total_penukaran_poin]").val())){var r=parseInt(t)-parseInt(v),o=(n.replace(".",","),parseInt(r)+parseInt(n/100*h)),_=parseInt(h)+parseInt(n/100*h);console.log(o),console.log(_),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(_);var s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-o;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{n.replace(".",","),o=parseInt(t)+parseInt(n/100*h),_=parseInt(h)+parseInt(n/100*h);console.log(o),console.log(_),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-o;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}else{var v;l=$("#x_id_kartu").val(),d=$("#x_jumlah_voucher").val();if(""!=l)axios.get(`api/?action=view&object=m_kartu&id_kartu=${l}`).then(function(a){var i=a.data.m_kartu.charge_price,e=$("[data-field=x_total_penukaran_poin]").val();if(""!=e){var l=parseInt(t)-parseInt(i)*d-parseInt(e),r=parseInt(l)+parseInt(n),o=parseInt(h)+parseInt(n);console.log(r),console.log(o),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(o);var _=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+o)-r;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{l=parseInt(t)-parseInt(i)*d,r=parseInt(l)+parseInt(n),o=parseInt(h)+parseInt(n);console.log(r),console.log(o),$("[data-field=x_total]").val(r),$("[data-field=x_total_non_tunai_charge]").val(o);_=parseInt($("[data-field=x_bayar]").val()),s=parseInt(_+o)-r;$("#kembalian").val(s),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}).catch(function(a){console.log(a)});else if(""!=(v=$("[data-field=x_total_penukaran_poin]").val())){r=parseInt(t)-parseInt(v),o=parseInt(r)+parseInt(n),_=parseInt(h)+parseInt(n);console.log(o),console.log(_),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-o;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}else{o=parseInt(t)+parseInt(n),_=parseInt(h)+parseInt(n);console.log(o),console.log(_),$("[data-field=x_total]").val(o),$("[data-field=x_total_non_tunai_charge]").val(_);s=parseInt($("[data-field=x_bayar]").val()),c=parseInt(s+_)-o;$("#kembalian").val(c),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak"))}}}).catch(function(a){$("[data-field=x_total_non_tunai_charge]").val(h);var t=parseInt($("[data-field=x_bayar]").val()),i=parseInt($("[data-field=x_bayar_non_tunai]").val()),n=parseInt(t+i)-g;$("#kembalian").val(n),$("#kembalian").val()<0?(btnLoading("btn-action"),btnLoading("btn-action-cetak")):$("#kembalian").val()>=0&&(btnLoadingGone("btn-action"),btnLoadingGoneCetak("btn-action-cetak")),console.log(a)})}),$("#x_id_kartu").change(function(){$("#x_jumlah_voucher").val("1");var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),charge=$("[data-field=x_charge]").val(),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,charge?charge=charge.split(",").join("."):charge=0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("[data-field=x_total_penukaran_poin]").val();if(""!=b){var u=parseInt(t)-b;$("[data-field=x_total]").val(u)}else $("[data-field=x_total]").val(t);var f=$("[data-field=x_total]").val(),k=$("#x_id_kartu").val(),g=$("#x_jumlah_voucher").val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var n=parseInt(f)-parseInt(t)*g-i;$("[data-field=x_total]").val(n)}else{n=parseInt(f)-parseInt(t)*g;$("[data-field=x_total]").val(n)}}).catch(function(a){console.log(a)})}),$("#x_jumlah_voucher").keyup(function(){var a,t,i,n,e,l="#"+$(this).attr("id").split("_")[0],d=l+"_harga_jual",r=l+"_qty",o=l+"_disc_pr",_=l+"_disc_rp",s=l+"_voucher_barang",c=l+"_subtotal",v=parseInt(0),p=0;d=$(d).val()?$(d).val().split(".").join(""):0,o=$(o).val()?$(o).val().split(",").join("."):0,a=d*$(r).val(),$(c).val(a-a*o/100-$(_).val()-$(s).val()),$("[data-field=x_subtotal]").each(function(){$(this).val()&&(v+=parseInt($(this).val()))}),charge=$("[data-field=x_charge]").val(),p=$("[data-field=x_diskon_persen]").val(),i=$("[data-field=x_diskon_rupiah]").val(),n=$("[data-field=x_ppn]").val(),e=$("[data-field=x_ongkir]").val(),p=p?p.split(",").join("."):0,charge?charge=charge.split(",").join("."):charge=0,t=v-i-v*p/100+v*n/100+parseInt(e);var b=$("[data-field=x_total_penukaran_poin]").val();if(""!=b){var u=parseInt(t)-b;$("[data-field=x_total]").val(u)}else $("[data-field=x_total]").val(t);var f=$("[data-field=x_total]").val(),k=$("#x_id_kartu").val(),g=$(this).val();axios.get(`api/?action=view&object=m_kartu&id_kartu=${k}`).then(function(a){var t=a.data.m_kartu.charge_price,i=$("[data-field=x_total_penukaran_poin]").val();if(""!=i){var n=parseInt(f)-parseInt(t)*g-i;$("[data-field=x_total]").val(n)}else{n=parseInt(f)-parseInt(t)*g;$("[data-field=x_total]").val(n)}}).catch(function(a){console.log(a)})});
});
</script>
